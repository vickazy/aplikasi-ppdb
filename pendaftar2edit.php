...
$pendaftar2_edit = NULL; // Initialize page object first

class cpendaftar2_edit extends cpendaftar2 {
	...
	// Page object name
	var $PageObjName = 'pendaftar2_edit';
	...
	function RenderRow() {
		...
		$this->keterangan->ViewCustomAttributes = "";
			...
			$this->nama_ruang->LookupFilters = array();
			ew_AddFilter($sWhereWrk, $sFilterWrk);
			if (!$GLOBALS["pendaftar2"]->UserIDAllow("edit")) $sWhereWrk = $GLOBALS["ruang"]->AddUserIDFilter($sWhereWrk);
			$this->Lookup_Selecting($this->nama_ruang, $sWhereWrk); // Call Lookup Selecting
			if ($sWhereWrk <> "") $sSqlWrk .= " WHERE " . $sWhereWrk;
			$rswrk = Conn()->Execute($sSqlWrk);
			$arwrk = ($rswrk) ? $rswrk->GetRows() : array();
			...
			$this->nomor_pendaftaran->LookupFilters = array("dx1" => '`nomor_pendaftaran`');
			ew_AddFilter($sWhereWrk, $sFilterWrk);
			if (!$GLOBALS["pendaftar2"]->UserIDAllow("edit")) $sWhereWrk = $GLOBALS["no_pendaftaran"]->AddUserIDFilter($sWhereWrk);
			$this->Lookup_Selecting($this->nomor_pendaftaran, $sWhereWrk); // Call Lookup Selecting
			if ($sWhereWrk <> "") $sSqlWrk .= " WHERE " . $sWhereWrk;
			$rswrk = Conn()->Execute($sSqlWrk);
			if ($rswrk && !$rswrk->EOF) { // Lookup values found
...
// Create page object
if (!isset($pendaftar2_edit)) $pendaftar2_edit = new cpendaftar2_edit();

// Page init
$pendaftar2_edit->Page_Init();

// Page main
$pendaftar2_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$pendaftar2_edit->Page_Render();
?>
...
var CurrentForm = fpendaftar2edit = new ew_Form("fpendaftar2edit", "edit");

// Validate form
fpendaftar2edit.Validate = function() {
...
fpendaftar2edit.Form_CustomValidate = 
...
fpendaftar2edit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Multi-Page
fpendaftar2edit.MultiPage = new ew_MultiPage("fpendaftar2edit");

// Dynamic selection lists
fpendaftar2edit.Lists["x_nama_ruang"] = {"LinkField":"x_nama_ruang","Ajax":true,"AutoFill":false,"DisplayFields":["x_nama_ruang","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"ruang"};
fpendaftar2edit.Lists["x_nama_ruang"].Data = "<?php echo $pendaftar2_edit->nama_ruang->LookupFilterQuery(FALSE, "edit") ?>";
fpendaftar2edit.Lists["x_nomor_pendaftaran"] = {"LinkField":"x_nomor_pendaftaran","Ajax":true,"AutoFill":false,"DisplayFields":["x_nomor_pendaftaran","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"no_pendaftaran"};
fpendaftar2edit.Lists["x_nomor_pendaftaran"].Data = "<?php echo $pendaftar2_edit->nomor_pendaftaran->LookupFilterQuery(FALSE, "edit") ?>";
fpendaftar2edit.Lists["x_nomor_peserta_ujian_sdmi"] = {"LinkField":"x_nopes","Ajax":true,"AutoFill":false,"DisplayFields":["x_nopes","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"db_pd"};
fpendaftar2edit.Lists["x_nomor_peserta_ujian_sdmi"].Data = "<?php echo $pendaftar2_edit->nomor_peserta_ujian_sdmi->LookupFilterQuery(FALSE, "edit") ?>";
fpendaftar2edit.AutoSuggests["x_nomor_peserta_ujian_sdmi"] = <?php echo json_encode(array("data" => "ajax=autosuggest&" . $pendaftar2_edit->nomor_peserta_ujian_sdmi->LookupFilterQuery(TRUE, "edit"))) ?>;
fpendaftar2edit.Lists["x_jenis_kelamin"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fpendaftar2edit.Lists["x_jenis_kelamin"].Options = <?php echo json_encode($pendaftar2_edit->jenis_kelamin->Options()) ?>;
fpendaftar2edit.Lists["x_agama"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fpendaftar2edit.Lists["x_agama"].Options = <?php echo json_encode($pendaftar2_edit->agama->Options()) ?>;
fpendaftar2edit.Lists["x_kecamatan"] = {"LinkField":"x_id_kec","Ajax":true,"AutoFill":true,"DisplayFields":["x_nama_kec","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"kecamatan"};
fpendaftar2edit.Lists["x_kecamatan"].Data = "<?php echo $pendaftar2_edit->kecamatan->LookupFilterQuery(FALSE, "edit") ?>";
fpendaftar2edit.Lists["x_bonus_prestasi"] = {"LinkField":"x_id_bonus","Ajax":true,"AutoFill":true,"DisplayFields":["x_bonus","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"bonus"};
fpendaftar2edit.Lists["x_bonus_prestasi"].Data = "<?php echo $pendaftar2_edit->bonus_prestasi->LookupFilterQuery(FALSE, "edit") ?>";
fpendaftar2edit.Lists["x_kepemilikan_ijasah_mda"] = {"LinkField":"x_id_mda","Ajax":true,"AutoFill":true,"DisplayFields":["x_mda","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"mda"};
fpendaftar2edit.Lists["x_kepemilikan_ijasah_mda"].Data = "<?php echo $pendaftar2_edit->kepemilikan_ijasah_mda->LookupFilterQuery(FALSE, "edit") ?>";
fpendaftar2edit.Lists["x_persyaratan"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fpendaftar2edit.Lists["x_persyaratan"].Options = <?php echo json_encode($pendaftar2_edit->persyaratan->Options()) ?>;
...
<?php $pendaftar2_edit->ShowPageHeader(); ?>
<?php
$pendaftar2_edit->ShowMessage();
?>
<form name="fpendaftar2edit" id="fpendaftar2edit" class="<?php echo $pendaftar2_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($pendaftar2_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $pendaftar2_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="pendaftar2">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="modal" value="<?php echo intval($pendaftar2_edit->IsModal) ?>">
<div class="ewMultiPage"><!-- multi-page -->
<div class="nav-tabs-custom" id="pendaftar2_edit"><!-- multi-page .nav-tabs-custom -->
	<ul class="nav<?php echo $pendaftar2_edit->MultiPages->NavStyle() ?>">
		<li<?php echo $pendaftar2_edit->MultiPages->TabStyle("1") ?>><a href="#tab_pendaftar21" data-toggle="tab"><?php echo $pendaftar2->PageCaption(1) ?></a></li>
		<li<?php echo $pendaftar2_edit->MultiPages->TabStyle("2") ?>><a href="#tab_pendaftar22" data-toggle="tab"><?php echo $pendaftar2->PageCaption(2) ?></a></li>
		<li<?php echo $pendaftar2_edit->MultiPages->TabStyle("3") ?>><a href="#tab_pendaftar23" data-toggle="tab"><?php echo $pendaftar2->PageCaption(3) ?></a></li>
	</ul>
	<div class="tab-content"><!-- multi-page .nav-tabs-custom .tab-content -->
		<div class="tab-pane<?php echo $pendaftar2_edit->MultiPages->PageStyle("1") ?>" id="tab_pendaftar21"><!-- multi-page .tab-pane -->
<div class="ewEditDiv"><!-- page* -->
<?php if ($pendaftar2->id_pendaftar->Visible) { // id_pendaftar ?>
	<div id="r_id_pendaftar" class="form-group">
		<label id="elh_pendaftar2_id_pendaftar" class="<?php echo $pendaftar2_edit->LeftColumnClass ?>"><?php echo $pendaftar2->id_pendaftar->FldCaption() ?></label>
		<div class="<?php echo $pendaftar2_edit->RightColumnClass ?>"><div<?php echo $pendaftar2->id_pendaftar->CellAttributes() ?>>
<span id="el_pendaftar2_id_pendaftar">
<span<?php echo $pendaftar2->id_pendaftar->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $pendaftar2->id_pendaftar->EditValue ?></p></span>
</span>
<input type="hidden" data-table="pendaftar2" data-field="x_id_pendaftar" data-page="1" name="x_id_pendaftar" id="x_id_pendaftar" value="<?php echo ew_HtmlEncode($pendaftar2->id_pendaftar->CurrentValue) ?>">
<?php echo $pendaftar2->id_pendaftar->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($pendaftar2->nama_ruang->Visible) { // nama_ruang ?>
	<div id="r_nama_ruang" class="form-group">
		<label id="elh_pendaftar2_nama_ruang" for="x_nama_ruang" class="<?php echo $pendaftar2_edit->LeftColumnClass ?>"><?php echo $pendaftar2->nama_ruang->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $pendaftar2_edit->RightColumnClass ?>"><div<?php echo $pendaftar2->nama_ruang->CellAttributes() ?>>
<?php if (!$Security->IsAdmin() && $Security->IsLoggedIn() && !$pendaftar2->UserIDAllow("edit")) { // Non system admin ?>
...
<?php if ($pendaftar2->nomor_pendaftaran->Visible) { // nomor_pendaftaran ?>
	<div id="r_nomor_pendaftaran" class="form-group">
		<label id="elh_pendaftar2_nomor_pendaftaran" for="x_nomor_pendaftaran" class="<?php echo $pendaftar2_edit->LeftColumnClass ?>"><?php echo $pendaftar2->nomor_pendaftaran->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $pendaftar2_edit->RightColumnClass ?>"><div<?php echo $pendaftar2->nomor_pendaftaran->CellAttributes() ?>>
...
<?php if ($pendaftar2->nomor_peserta_ujian_sdmi->Visible) { // nomor_peserta_ujian_sdmi ?>
	<div id="r_nomor_peserta_ujian_sdmi" class="form-group">
		<label id="elh_pendaftar2_nomor_peserta_ujian_sdmi" class="<?php echo $pendaftar2_edit->LeftColumnClass ?>"><?php echo $pendaftar2->nomor_peserta_ujian_sdmi->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $pendaftar2_edit->RightColumnClass ?>"><div<?php echo $pendaftar2->nomor_peserta_ujian_sdmi->CellAttributes() ?>>
...
<script type="text/javascript">
fpendaftar2edit.CreateAutoSuggest({"id":"x_nomor_peserta_ujian_sdmi","forceSelect":false});
</script>
</span>
...
<?php if ($pendaftar2->sekolah_asal->Visible) { // sekolah_asal ?>
	<div id="r_sekolah_asal" class="form-group">
		<label id="elh_pendaftar2_sekolah_asal" for="x_sekolah_asal" class="<?php echo $pendaftar2_edit->LeftColumnClass ?>"><?php echo $pendaftar2->sekolah_asal->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $pendaftar2_edit->RightColumnClass ?>"><div<?php echo $pendaftar2->sekolah_asal->CellAttributes() ?>>
...
<?php if ($pendaftar2->nama_lengkap->Visible) { // nama_lengkap ?>
	<div id="r_nama_lengkap" class="form-group">
		<label id="elh_pendaftar2_nama_lengkap" for="x_nama_lengkap" class="<?php echo $pendaftar2_edit->LeftColumnClass ?>"><?php echo $pendaftar2->nama_lengkap->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $pendaftar2_edit->RightColumnClass ?>"><div<?php echo $pendaftar2->nama_lengkap->CellAttributes() ?>>
...
<?php if ($pendaftar2->nik->Visible) { // nik ?>
	<div id="r_nik" class="form-group">
		<label id="elh_pendaftar2_nik" for="x_nik" class="<?php echo $pendaftar2_edit->LeftColumnClass ?>"><?php echo $pendaftar2->nik->FldCaption() ?></label>
		<div class="<?php echo $pendaftar2_edit->RightColumnClass ?>"><div<?php echo $pendaftar2->nik->CellAttributes() ?>>
...
<?php if ($pendaftar2->nisn->Visible) { // nisn ?>
	<div id="r_nisn" class="form-group">
		<label id="elh_pendaftar2_nisn" for="x_nisn" class="<?php echo $pendaftar2_edit->LeftColumnClass ?>"><?php echo $pendaftar2->nisn->FldCaption() ?></label>
		<div class="<?php echo $pendaftar2_edit->RightColumnClass ?>"><div<?php echo $pendaftar2->nisn->CellAttributes() ?>>
...
<?php if ($pendaftar2->tempat_lahir->Visible) { // tempat_lahir ?>
	<div id="r_tempat_lahir" class="form-group">
		<label id="elh_pendaftar2_tempat_lahir" for="x_tempat_lahir" class="<?php echo $pendaftar2_edit->LeftColumnClass ?>"><?php echo $pendaftar2->tempat_lahir->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $pendaftar2_edit->RightColumnClass ?>"><div<?php echo $pendaftar2->tempat_lahir->CellAttributes() ?>>
...
<?php if ($pendaftar2->tanggal_lahir->Visible) { // tanggal_lahir ?>
	<div id="r_tanggal_lahir" class="form-group">
		<label id="elh_pendaftar2_tanggal_lahir" for="x_tanggal_lahir" class="<?php echo $pendaftar2_edit->LeftColumnClass ?>"><?php echo $pendaftar2->tanggal_lahir->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $pendaftar2_edit->RightColumnClass ?>"><div<?php echo $pendaftar2->tanggal_lahir->CellAttributes() ?>>
...
<script type="text/javascript">
ew_CreateDateTimePicker("fpendaftar2edit", "x_tanggal_lahir", {"ignoreReadonly":true,"useCurrent":false,"format":7});
</script>
<?php } ?>
</span>
...
<?php if ($pendaftar2->jenis_kelamin->Visible) { // jenis_kelamin ?>
	<div id="r_jenis_kelamin" class="form-group">
		<label id="elh_pendaftar2_jenis_kelamin" class="<?php echo $pendaftar2_edit->LeftColumnClass ?>"><?php echo $pendaftar2->jenis_kelamin->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $pendaftar2_edit->RightColumnClass ?>"><div<?php echo $pendaftar2->jenis_kelamin->CellAttributes() ?>>
...
<?php if ($pendaftar2->agama->Visible) { // agama ?>
	<div id="r_agama" class="form-group">
		<label id="elh_pendaftar2_agama" for="x_agama" class="<?php echo $pendaftar2_edit->LeftColumnClass ?>"><?php echo $pendaftar2->agama->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $pendaftar2_edit->RightColumnClass ?>"><div<?php echo $pendaftar2->agama->CellAttributes() ?>>
...
<?php if ($pendaftar2->alamat->Visible) { // alamat ?>
	<div id="r_alamat" class="form-group">
		<label id="elh_pendaftar2_alamat" for="x_alamat" class="<?php echo $pendaftar2_edit->LeftColumnClass ?>"><?php echo $pendaftar2->alamat->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $pendaftar2_edit->RightColumnClass ?>"><div<?php echo $pendaftar2->alamat->CellAttributes() ?>>
...
<?php if ($pendaftar2->kecamatan->Visible) { // kecamatan ?>
	<div id="r_kecamatan" class="form-group">
		<label id="elh_pendaftar2_kecamatan" for="x_kecamatan" class="<?php echo $pendaftar2_edit->LeftColumnClass ?>"><?php echo $pendaftar2->kecamatan->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $pendaftar2_edit->RightColumnClass ?>"><div<?php echo $pendaftar2->kecamatan->CellAttributes() ?>>
...
<?php if ($pendaftar2->zona->Visible) { // zona ?>
	<div id="r_zona" class="form-group">
		<label id="elh_pendaftar2_zona" for="x_zona" class="<?php echo $pendaftar2_edit->LeftColumnClass ?>"><?php echo $pendaftar2->zona->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $pendaftar2_edit->RightColumnClass ?>"><div<?php echo $pendaftar2->zona->CellAttributes() ?>>
<span id="el_pendaftar2_zona">
<input type="text" data-table="pendaftar2" data-field="x_zona" data-page="1" name="x_zona" id="x_zona" size="30" maxlength="50" placeholder="<?php echo ew_HtmlEncode($pendaftar2->zona->getPlaceHolder()) ?>" value="<?php echo $pendaftar2->zona->EditValue ?>"<?php echo $pendaftar2->zona->EditAttributes() ?>>
</span>
...
<?php if ($pendaftar2->nama_ayah->Visible) { // nama_ayah ?>
	<div id="r_nama_ayah" class="form-group">
		<label id="elh_pendaftar2_nama_ayah" for="x_nama_ayah" class="<?php echo $pendaftar2_edit->LeftColumnClass ?>"><?php echo $pendaftar2->nama_ayah->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $pendaftar2_edit->RightColumnClass ?>"><div<?php echo $pendaftar2->nama_ayah->CellAttributes() ?>>
...
<?php if ($pendaftar2->nama_ibu->Visible) { // nama_ibu ?>
	<div id="r_nama_ibu" class="form-group">
		<label id="elh_pendaftar2_nama_ibu" for="x_nama_ibu" class="<?php echo $pendaftar2_edit->LeftColumnClass ?>"><?php echo $pendaftar2->nama_ibu->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $pendaftar2_edit->RightColumnClass ?>"><div<?php echo $pendaftar2->nama_ibu->CellAttributes() ?>>
...
<?php if ($pendaftar2->nama_wali->Visible) { // nama_wali ?>
	<div id="r_nama_wali" class="form-group">
		<label id="elh_pendaftar2_nama_wali" for="x_nama_wali" class="<?php echo $pendaftar2_edit->LeftColumnClass ?>"><?php echo $pendaftar2->nama_wali->FldCaption() ?></label>
		<div class="<?php echo $pendaftar2_edit->RightColumnClass ?>"><div<?php echo $pendaftar2->nama_wali->CellAttributes() ?>>
...
<?php } ?>
		...
		<div class="tab-pane<?php echo $pendaftar2_edit->MultiPages->PageStyle("2") ?>" id="tab_pendaftar22"><!-- multi-page .tab-pane -->
<div class="ewEditDiv"><!-- page* -->
<?php if ($pendaftar2->n_ind->Visible) { // n_ind ?>
	<div id="r_n_ind" class="form-group">
		<label id="elh_pendaftar2_n_ind" for="x_n_ind" class="<?php echo $pendaftar2_edit->LeftColumnClass ?>"><?php echo $pendaftar2->n_ind->FldCaption() ?></label>
		<div class="<?php echo $pendaftar2_edit->RightColumnClass ?>"><div<?php echo $pendaftar2->n_ind->CellAttributes() ?>>
<span id="el_pendaftar2_n_ind">
<span<?php echo $pendaftar2->n_ind->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $pendaftar2->n_ind->EditValue ?></p></span>
</span>
<input type="hidden" data-table="pendaftar2" data-field="x_n_ind" data-page="2" name="x_n_ind" id="x_n_ind" value="<?php echo ew_HtmlEncode($pendaftar2->n_ind->CurrentValue) ?>">
<?php echo $pendaftar2->n_ind->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($pendaftar2->n_mat->Visible) { // n_mat ?>
	<div id="r_n_mat" class="form-group">
		<label id="elh_pendaftar2_n_mat" for="x_n_mat" class="<?php echo $pendaftar2_edit->LeftColumnClass ?>"><?php echo $pendaftar2->n_mat->FldCaption() ?></label>
		<div class="<?php echo $pendaftar2_edit->RightColumnClass ?>"><div<?php echo $pendaftar2->n_mat->CellAttributes() ?>>
<span id="el_pendaftar2_n_mat">
<span<?php echo $pendaftar2->n_mat->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $pendaftar2->n_mat->EditValue ?></p></span>
</span>
<input type="hidden" data-table="pendaftar2" data-field="x_n_mat" data-page="2" name="x_n_mat" id="x_n_mat" value="<?php echo ew_HtmlEncode($pendaftar2->n_mat->CurrentValue) ?>">
<?php echo $pendaftar2->n_mat->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($pendaftar2->n_ipa->Visible) { // n_ipa ?>
	<div id="r_n_ipa" class="form-group">
		<label id="elh_pendaftar2_n_ipa" for="x_n_ipa" class="<?php echo $pendaftar2_edit->LeftColumnClass ?>"><?php echo $pendaftar2->n_ipa->FldCaption() ?></label>
		<div class="<?php echo $pendaftar2_edit->RightColumnClass ?>"><div<?php echo $pendaftar2->n_ipa->CellAttributes() ?>>
<span id="el_pendaftar2_n_ipa">
<span<?php echo $pendaftar2->n_ipa->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $pendaftar2->n_ipa->EditValue ?></p></span>
</span>
<input type="hidden" data-table="pendaftar2" data-field="x_n_ipa" data-page="2" name="x_n_ipa" id="x_n_ipa" value="<?php echo ew_HtmlEncode($pendaftar2->n_ipa->CurrentValue) ?>">
...
<?php if ($pendaftar2->jumlah_nilai_usum->Visible) { // jumlah_nilai_usum ?>
	<div id="r_jumlah_nilai_usum" class="form-group">
		<label id="elh_pendaftar2_jumlah_nilai_usum" for="x_jumlah_nilai_usum" class="<?php echo $pendaftar2_edit->LeftColumnClass ?>"><?php echo $pendaftar2->jumlah_nilai_usum->FldCaption() ?></label>
		<div class="<?php echo $pendaftar2_edit->RightColumnClass ?>"><div<?php echo $pendaftar2->jumlah_nilai_usum->CellAttributes() ?>>
<span id="el_pendaftar2_jumlah_nilai_usum">
<span<?php echo $pendaftar2->jumlah_nilai_usum->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $pendaftar2->jumlah_nilai_usum->EditValue ?></p></span>
</span>
<input type="hidden" data-table="pendaftar2" data-field="x_jumlah_nilai_usum" data-page="2" name="x_jumlah_nilai_usum" id="x_jumlah_nilai_usum" value="<?php echo ew_HtmlEncode($pendaftar2->jumlah_nilai_usum->CurrentValue) ?>">
...
<?php if ($pendaftar2->bonus_prestasi->Visible) { // bonus_prestasi ?>
	<div id="r_bonus_prestasi" class="form-group">
		<label id="elh_pendaftar2_bonus_prestasi" for="x_bonus_prestasi" class="<?php echo $pendaftar2_edit->LeftColumnClass ?>"><?php echo $pendaftar2->bonus_prestasi->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $pendaftar2_edit->RightColumnClass ?>"><div<?php echo $pendaftar2->bonus_prestasi->CellAttributes() ?>>
...
<?php if ($pendaftar2->nama_prestasi->Visible) { // nama_prestasi ?>
	<div id="r_nama_prestasi" class="form-group">
		<label id="elh_pendaftar2_nama_prestasi" for="x_nama_prestasi" class="<?php echo $pendaftar2_edit->LeftColumnClass ?>"><?php echo $pendaftar2->nama_prestasi->FldCaption() ?></label>
		<div class="<?php echo $pendaftar2_edit->RightColumnClass ?>"><div<?php echo $pendaftar2->nama_prestasi->CellAttributes() ?>>
...
<?php if ($pendaftar2->kepemilikan_ijasah_mda->Visible) { // kepemilikan_ijasah_mda ?>
	<div id="r_kepemilikan_ijasah_mda" class="form-group">
		<label id="elh_pendaftar2_kepemilikan_ijasah_mda" class="<?php echo $pendaftar2_edit->LeftColumnClass ?>"><?php echo $pendaftar2->kepemilikan_ijasah_mda->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $pendaftar2_edit->RightColumnClass ?>"><div<?php echo $pendaftar2->kepemilikan_ijasah_mda->CellAttributes() ?>>
...
<?php if ($pendaftar2->nilai_akhir->Visible) { // nilai_akhir ?>
	<div id="r_nilai_akhir" class="form-group">
		<label id="elh_pendaftar2_nilai_akhir" for="x_nilai_akhir" class="<?php echo $pendaftar2_edit->LeftColumnClass ?>"><?php echo $pendaftar2->nilai_akhir->FldCaption() ?></label>
		<div class="<?php echo $pendaftar2_edit->RightColumnClass ?>"><div<?php echo $pendaftar2->nilai_akhir->CellAttributes() ?>>
...
<?php } ?>
		...
		<div class="tab-pane<?php echo $pendaftar2_edit->MultiPages->PageStyle("3") ?>" id="tab_pendaftar23"><!-- multi-page .tab-pane -->
<div class="ewEditDiv"><!-- page* -->
<?php if ($pendaftar2->persyaratan->Visible) { // persyaratan ?>
	<div id="r_persyaratan" class="form-group">
		<label id="elh_pendaftar2_persyaratan" class="<?php echo $pendaftar2_edit->LeftColumnClass ?>"><?php echo $pendaftar2->persyaratan->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $pendaftar2_edit->RightColumnClass ?>"><div<?php echo $pendaftar2->persyaratan->CellAttributes() ?>>
...
<?php if ($pendaftar2->catatan->Visible) { // catatan ?>
	<div id="r_catatan" class="form-group">
		<label id="elh_pendaftar2_catatan" for="x_catatan" class="<?php echo $pendaftar2_edit->LeftColumnClass ?>"><?php echo $pendaftar2->catatan->FldCaption() ?></label>
		<div class="<?php echo $pendaftar2_edit->RightColumnClass ?>"><div<?php echo $pendaftar2->catatan->CellAttributes() ?>>
...
<input type="hidden" data-table="pendaftar2" data-field="x_jumlah_bonus_prestasi" data-page="2" name="x_jumlah_bonus_prestasi" id="x_jumlah_bonus_prestasi" value="<?php echo ew_HtmlEncode($pendaftar2->jumlah_bonus_prestasi->CurrentValue) ?>">
</span>
<span id="el_pendaftar2_nilai_mda">
<input type="hidden" data-table="pendaftar2" data-field="x_nilai_mda" data-page="2" name="x_nilai_mda" id="x_nilai_mda" value="<?php echo ew_HtmlEncode($pendaftar2->nilai_mda->CurrentValue) ?>">
</span>
<?php if (!$pendaftar2_edit->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $pendaftar2_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $pendaftar2_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<script type="text/javascript">
fpendaftar2edit.Init();
</script>
<?php
$pendaftar2_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$pendaftar2_edit->Page_Terminate();
?>
