...
$pendaftar_view = NULL; // Initialize page object first

class cpendaftar_view extends cpendaftar {
	...
	// Page object name
	var $PageObjName = 'pendaftar_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["id_pendaftar"] <> "") {
				...
				$sReturnUrl = "pendaftarlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "pendaftarlist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "pendaftarlist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($pendaftar_view)) $pendaftar_view = new cpendaftar_view();

// Page init
$pendaftar_view->Page_Init();

// Page main
$pendaftar_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$pendaftar_view->Page_Render();
?>
...
var CurrentForm = fpendaftarview = new ew_Form("fpendaftarview", "view");

// Form_CustomValidate event
fpendaftarview.Form_CustomValidate = 
...
fpendaftarview.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fpendaftarview.Lists["x_nama_ruang"] = {"LinkField":"x_nama_ruang","Ajax":true,"AutoFill":false,"DisplayFields":["x_nama_ruang","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"ruang"};
fpendaftarview.Lists["x_nama_ruang"].Data = "<?php echo $pendaftar_view->nama_ruang->LookupFilterQuery(FALSE, "view") ?>";
fpendaftarview.Lists["x_nomor_pendaftaran"] = {"LinkField":"x_nomor_pendaftaran","Ajax":true,"AutoFill":false,"DisplayFields":["x_nomor_pendaftaran","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"no_pendaftaran"};
fpendaftarview.Lists["x_nomor_pendaftaran"].Data = "<?php echo $pendaftar_view->nomor_pendaftaran->LookupFilterQuery(FALSE, "view") ?>";
fpendaftarview.Lists["x_nomor_peserta_ujian_sdmi"] = {"LinkField":"x_nopes","Ajax":true,"AutoFill":false,"DisplayFields":["x_nopes","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"db_pd"};
fpendaftarview.Lists["x_nomor_peserta_ujian_sdmi"].Data = "<?php echo $pendaftar_view->nomor_peserta_ujian_sdmi->LookupFilterQuery(FALSE, "view") ?>";
fpendaftarview.Lists["x_jenis_kelamin"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fpendaftarview.Lists["x_jenis_kelamin"].Options = <?php echo json_encode($pendaftar_view->jenis_kelamin->Options()) ?>;
fpendaftarview.Lists["x_agama"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fpendaftarview.Lists["x_agama"].Options = <?php echo json_encode($pendaftar_view->agama->Options()) ?>;
fpendaftarview.Lists["x_kecamatan"] = {"LinkField":"x_id_kec","Ajax":true,"AutoFill":false,"DisplayFields":["x_nama_kec","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"kecamatan"};
fpendaftarview.Lists["x_kecamatan"].Data = "<?php echo $pendaftar_view->kecamatan->LookupFilterQuery(FALSE, "view") ?>";
fpendaftarview.Lists["x_bonus_prestasi"] = {"LinkField":"x_id_bonus","Ajax":true,"AutoFill":false,"DisplayFields":["x_bonus","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"bonus"};
fpendaftarview.Lists["x_bonus_prestasi"].Data = "<?php echo $pendaftar_view->bonus_prestasi->LookupFilterQuery(FALSE, "view") ?>";
fpendaftarview.Lists["x_kepemilikan_ijasah_mda"] = {"LinkField":"x_id_mda","Ajax":true,"AutoFill":false,"DisplayFields":["x_mda","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"mda"};
fpendaftarview.Lists["x_kepemilikan_ijasah_mda"].Data = "<?php echo $pendaftar_view->kepemilikan_ijasah_mda->LookupFilterQuery(FALSE, "view") ?>";
fpendaftarview.Lists["x_persyaratan"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fpendaftarview.Lists["x_persyaratan"].Options = <?php echo json_encode($pendaftar_view->persyaratan->Options()) ?>;
...
<?php if ($pendaftar->Export == "") { ?>
<div class="ewToolbar">
<?php $pendaftar_view->ExportOptions->Render("body") ?>
<?php
	foreach ($pendaftar_view->OtherOptions as &$option)
		$option->Render("body");
?>
<div class="clearfix"></div>
</div>
<?php } ?>
<?php $pendaftar_view->ShowPageHeader(); ?>
<?php
$pendaftar_view->ShowMessage();
?>
<form name="fpendaftarview" id="fpendaftarview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
  <p>
  <?php if ($pendaftar_view->CheckToken) { ?>
  <input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $pendaftar_view->Token ?>">
  <?php } ?>
  <input type="hidden" name="t" value="pendaftar">
  <input type="hidden" name="modal" value="<?php echo intval($pendaftar_view->IsModal) ?>">
</p>
  <table width="100%" cellpadding="0" cellspacing="0">
    ...
    <tr height="20">
      ...
      <td colspan="4"><?php echo $pendaftar->nama_ruang->ViewValue ?></td>
    </tr>
    <tr height="20">
      <td height="20" width="181"><strong>No Pendaftaran</strong></td>
      <td colspan="4"><?php echo $pendaftar->nomor_pendaftaran->ViewValue ?></td>
    </tr>
    <tr height="20">
      <td height="20" width="181"><strong>No Pes Ujian SD/MI</strong></td>
      <td colspan="4"><?php echo $pendaftar->nomor_peserta_ujian_sdmi->ViewValue ?></td>
    </tr>
    <tr height="20">
      <td height="20" width="181"><strong>Sekolah Asal</strong></td>
      <td colspan="4"><?php echo $pendaftar->sekolah_asal->ViewValue ?></td>
    </tr>
    <tr height="20">
      <td height="20" width="181"><strong>Nama</strong></td>
      <td colspan="4"><?php echo $pendaftar->nama_lengkap->ViewValue ?></td>
    </tr>
    <tr height="20">
      <td height="20" width="181"><strong>NIK</strong></td>
      <td colspan="4"><?php echo $pendaftar->nik->ViewValue ?></td>
    </tr>
    <tr height="20">
      <td height="20" width="181"><strong>NISN</strong></td>
      <td colspan="4"><?php echo $pendaftar->nisn->ViewValue ?></td>
    </tr>
    <tr height="20">
      <td height="20" width="181"><strong>Tempat Lahir</strong></td>
      <td colspan="4"><?php echo $pendaftar->tempat_lahir->ViewValue ?></td>
    </tr>
    <tr height="20">
      <td height="20" width="181"><strong>Tanggal Lahir</strong></td>
      <td colspan="4"><?php echo $pendaftar->tanggal_lahir->ViewValue ?></td>
    </tr>
    <tr height="20">
      <td height="20" width="181"><strong>Jk</strong></td>
      <td colspan="4"><?php echo $pendaftar->jenis_kelamin->ViewValue ?></td>
    </tr>
    <tr height="20">
      <td height="20" width="181"><strong>Agama</strong></td>
      <td colspan="4"><?php echo $pendaftar->agama->ViewValue ?></td>
    </tr>
    <tr height="45">
      <td height="45" width="181"><strong>Alamat Lengkap</strong></td>
      <td colspan="4"><?php echo $pendaftar->alamat->ViewValue ?></td>
    </tr>
    <tr height="20">
      <td height="20" width="181"><strong>Kecamatan dan Zona</strong></td>
      <td width="158" colspan="3"><?php echo $pendaftar->kecamatan->ViewValue ?></td>
      <td width="64"><?php echo $pendaftar->zona->ViewValue ?></td>
    </tr>
    <tr height="20">
    ...
    <tr height="20">
      <td colspan="5" height="20"><table width="100%" border="1" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td><div align="center"><?php echo $pendaftar->n_ind->ViewValue ?></div></td>
          <td><div align="center"><?php echo $pendaftar->n_mat->ViewValue ?></div></td>
          <td><div align="center"><?php echo $pendaftar->n_ipa->ViewValue ?></div></td>
          <td><div align="center"><?php echo $pendaftar->jumlah_nilai_usum->ViewValue ?></div></td>
        </tr>
    ...
    <tr height="20">
      ...
      <td colspan="4"><?php echo $pendaftar->nama_prestasi->ViewValue ?></td>
    </tr>
    <tr height="20">
      <td height="20" width="181"><strong>MDA</strong></td>
      <td colspan="4"><?php echo $pendaftar->kepemilikan_ijasah_mda->ViewValue ?></td>
    </tr>
    <tr height="20">
      <td height="20" width="181"><strong>Nilai Akhir</strong></td>
      <td colspan="4"><?php echo $pendaftar->nilai_akhir->ViewValue ?></td>
    </tr>
    <tr height="20">
      <td height="20" width="181"><strong>Nama Ayah</strong></td>
      <td colspan="4"><?php echo $pendaftar->nama_ayah->ViewValue ?></td>
    </tr>
    <tr height="20">
      <td height="20" width="181"><strong>Nama Ibu</strong></td>
      <td colspan="4"><?php echo $pendaftar->nama_ibu->ViewValue ?></td>
    </tr>
    <tr height="20">
      <td height="20" width="181"><strong>Nama Wali</strong></td>
      <td colspan="4"><?php echo $pendaftar->nama_wali->ViewValue ?></td>
    </tr>
    <tr height="20">
      <td height="20" width="181"><strong>Status</strong></td>
      <td colspan="4"><?php echo $pendaftar->status->ViewValue ?></td>
    </tr>
    <tr height="20">
      <td height="20" width="181"><strong>Persyaratan</strong></td>
      <td colspan="4"><?php echo $pendaftar->persyaratan->ViewValue ?></td>
    </tr>
    <tr height="20">
      <td height="20" width="181"><strong>Catatan</strong></td>
      <td colspan="4"><?php echo $pendaftar->catatan->ViewValue ?></td>
    </tr>
    <tr height="20">
      <td height="20">&nbsp;</td>
      <td colspan="4">&nbsp;</td>
    ...
    <tr height="20">
      <td height="20">&nbsp;</td>
      <td colspan="4"><strong><?php echo $pendaftar->nama_lengkap->ViewValue ?></strong></td>
    </tr>
    <tr height="20">
      <td height="20">&nbsp;</td>
      <td colspan="4">&nbsp;</td>
