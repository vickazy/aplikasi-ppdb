...
//
// Table class for no_dftr
//
class cno_dftr extends cTable {
	var $id_no;
	var $nomor;
	var $nama_ruang;
	...
	function __construct() {
		...
		$this->TableVar = 'no_dftr';
		$this->TableName = 'no_dftr';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`no_dftr`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id_no
		$this->id_no = new cField('no_dftr', 'no_dftr', 'x_id_no', 'id_no', '`id_no`', '`id_no`', 3, -1, FALSE, '`id_no`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// nomor
		$this->nomor = new cField('no_dftr', 'no_dftr', 'x_nomor', 'nomor', '`nomor`', '`nomor`', 19, -1, FALSE, '`nomor`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// nama_ruang
		$this->nama_ruang = new cField('no_dftr', 'no_dftr', 'x_nama_ruang', 'nama_ruang', '`nama_ruang`', '`nama_ruang`', 200, -1, FALSE, '`nama_ruang`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`no_dftr`";
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "no_dftredit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "no_dftradd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("no_dftrview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("no_dftrview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "no_dftradd.php?" . $this->UrlParm($parm);
		else
			$url = "no_dftradd.php";
		return $this->AddMasterUrl($url);
	}
	...
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("no_dftredit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("no_dftradd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("no_dftrdelete.php", $this->UrlParm());
	}
	...
	function GetUserIDSubquery(&$fld, &$masterfld) {
		...
		$sWrk = "";
		$sSql = "SELECT " . $masterfld->FldExpression . " FROM `no_dftr`";
