...
class cruang_edit extends cruang {
	...
	function Page_Init() {
		...
		$this->id_ruang->SetVisibility();
		$this->id_ruang->Visible = !$this->IsAdd() && !$this->IsCopy() && !$this->IsGridAdd();
	...
	function Page_Main() {
		...
		if (@$_POST["a_edit"] <> "") {
			...
			// Load key from Form
			if ($objForm->HasValue("x_id_ruang")) {
	...
	function LoadFormValues() {
		...
		// Load from form
		global $objForm;
		if (!$this->id_ruang->FldIsDetailKey)
			$this->id_ruang->setFormValue($objForm->GetValue("x_id_ruang"));
...
fruangedit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<input type="hidden" name="modal" value="<?php echo intval($ruang_edit->IsModal) ?>">
<!-- Fields to prevent google autofill -->
<input class="hidden" type="text" name="<?php echo ew_Encrypt(ew_Random()) ?>">
<input class="hidden" type="password" name="<?php echo ew_Encrypt(ew_Random()) ?>">
<div class="ewEditDiv"><!-- page* -->
<?php if ($ruang->id_ruang->Visible) { // id_ruang ?>
	<div id="r_id_ruang" class="form-group">
		<label id="elh_ruang_id_ruang" class="<?php echo $ruang_edit->LeftColumnClass ?>"><?php echo $ruang->id_ruang->FldCaption() ?></label>
		<div class="<?php echo $ruang_edit->RightColumnClass ?>"><div<?php echo $ruang->id_ruang->CellAttributes() ?>>
<span id="el_ruang_id_ruang">
<span<?php echo $ruang->id_ruang->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $ruang->id_ruang->EditValue ?></p></span>
</span>
<input type="hidden" data-table="ruang" data-field="x_id_ruang" name="x_id_ruang" id="x_id_ruang" value="<?php echo ew_HtmlEncode($ruang->id_ruang->CurrentValue) ?>">
<?php echo $ruang->id_ruang->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($ruang->nama_ruang->Visible) { // nama_ruang ?>
	<div id="r_nama_ruang" class="form-group">
		<label id="elh_ruang_nama_ruang" for="x_nama_ruang" class="<?php echo $ruang_edit->LeftColumnClass ?>"><?php echo $ruang->nama_ruang->FldCaption() ?></label>
		<div class="<?php echo $ruang_edit->RightColumnClass ?>"><div<?php echo $ruang->nama_ruang->CellAttributes() ?>>
...
<input type="hidden" data-table="ruang" data-field="x_nama_ruang" name="x_nama_ruang" id="x_nama_ruang" value="<?php echo ew_HtmlEncode($ruang->nama_ruang->CurrentValue) ?>">
<?php echo $ruang->nama_ruang->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($ruang->pwd->Visible) { // pwd ?>
	<div id="r_pwd" class="form-group">
		<label id="elh_ruang_pwd" for="x_pwd" class="<?php echo $ruang_edit->LeftColumnClass ?>"><?php echo $ruang->pwd->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $ruang_edit->RightColumnClass ?>"><div<?php echo $ruang->pwd->CellAttributes() ?>>
...
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $ruang_edit->OffsetColumnClass ?>"><!-- buttons offset -->
