...
$pendaftar2_delete = NULL; // Initialize page object first

class cpendaftar2_delete extends cpendaftar2 {
	...
	// Page object name
	var $PageObjName = 'pendaftar2_delete';
	...
	function Page_Main() {
		...
		if ($sFilter == "")
			$this->Page_Terminate("pendaftar2list.php"); // Prevent SQL injection, return to list

		// Set up filter (SQL WHHERE clause) and get return SQL
		// SQL constructor in pendaftar2 class, pendaftar2info.php
		...
		if ($this->Recordset = ew_LoadRecordset($sql, $conn)) {
			...
			if (!$res) $this->Page_Terminate("pendaftar2list.php"); // Return to list
		}
		...
		if ($this->CurrentAction == "I") { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				if ($this->Recordset)
					$this->Recordset->Close();
				$this->Page_Terminate("pendaftar2list.php"); // Return to list
			}
		}
	}
...
// Create page object
if (!isset($pendaftar2_delete)) $pendaftar2_delete = new cpendaftar2_delete();

// Page init
$pendaftar2_delete->Page_Init();

// Page main
$pendaftar2_delete->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$pendaftar2_delete->Page_Render();
?>
...
var CurrentForm = fpendaftar2delete = new ew_Form("fpendaftar2delete", "delete");

// Form_CustomValidate event
fpendaftar2delete.Form_CustomValidate = 
...
fpendaftar2delete.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fpendaftar2delete.Lists["x_nama_ruang"] = {"LinkField":"x_nama_ruang","Ajax":true,"AutoFill":false,"DisplayFields":["x_nama_ruang","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"ruang"};
fpendaftar2delete.Lists["x_nama_ruang"].Data = "<?php echo $pendaftar2_delete->nama_ruang->LookupFilterQuery(FALSE, "delete") ?>";
fpendaftar2delete.Lists["x_nomor_pendaftaran"] = {"LinkField":"x_nomor_pendaftaran","Ajax":true,"AutoFill":false,"DisplayFields":["x_nomor_pendaftaran","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"no_pendaftaran"};
fpendaftar2delete.Lists["x_nomor_pendaftaran"].Data = "<?php echo $pendaftar2_delete->nomor_pendaftaran->LookupFilterQuery(FALSE, "delete") ?>";
fpendaftar2delete.Lists["x_nomor_peserta_ujian_sdmi"] = {"LinkField":"x_nopes","Ajax":true,"AutoFill":false,"DisplayFields":["x_nopes","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"db_pd"};
fpendaftar2delete.Lists["x_nomor_peserta_ujian_sdmi"].Data = "<?php echo $pendaftar2_delete->nomor_peserta_ujian_sdmi->LookupFilterQuery(FALSE, "delete") ?>";
fpendaftar2delete.AutoSuggests["x_nomor_peserta_ujian_sdmi"] = <?php echo json_encode(array("data" => "ajax=autosuggest&" . $pendaftar2_delete->nomor_peserta_ujian_sdmi->LookupFilterQuery(TRUE, "delete"))) ?>;
fpendaftar2delete.Lists["x_jenis_kelamin"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fpendaftar2delete.Lists["x_jenis_kelamin"].Options = <?php echo json_encode($pendaftar2_delete->jenis_kelamin->Options()) ?>;
fpendaftar2delete.Lists["x_persyaratan"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fpendaftar2delete.Lists["x_persyaratan"].Options = <?php echo json_encode($pendaftar2_delete->persyaratan->Options()) ?>;
...
<?php $pendaftar2_delete->ShowPageHeader(); ?>
<?php
$pendaftar2_delete->ShowMessage();
?>
<form name="fpendaftar2delete" id="fpendaftar2delete" class="form-inline ewForm ewDeleteForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($pendaftar2_delete->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $pendaftar2_delete->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="pendaftar2">
<input type="hidden" name="a_delete" id="a_delete" value="D">
<?php foreach ($pendaftar2_delete->RecKeys as $key) { ?>
...
<?php if ($pendaftar2->nama_ruang->Visible) { // nama_ruang ?>
		<th class="<?php echo $pendaftar2->nama_ruang->HeaderCellClass() ?>"><span id="elh_pendaftar2_nama_ruang" class="pendaftar2_nama_ruang"><?php echo $pendaftar2->nama_ruang->FldCaption() ?></span></th>
<?php } ?>
<?php if ($pendaftar2->nomor_pendaftaran->Visible) { // nomor_pendaftaran ?>
		<th class="<?php echo $pendaftar2->nomor_pendaftaran->HeaderCellClass() ?>"><span id="elh_pendaftar2_nomor_pendaftaran" class="pendaftar2_nomor_pendaftaran"><?php echo $pendaftar2->nomor_pendaftaran->FldCaption() ?></span></th>
<?php } ?>
<?php if ($pendaftar2->nomor_peserta_ujian_sdmi->Visible) { // nomor_peserta_ujian_sdmi ?>
		<th class="<?php echo $pendaftar2->nomor_peserta_ujian_sdmi->HeaderCellClass() ?>"><span id="elh_pendaftar2_nomor_peserta_ujian_sdmi" class="pendaftar2_nomor_peserta_ujian_sdmi"><?php echo $pendaftar2->nomor_peserta_ujian_sdmi->FldCaption() ?></span></th>
<?php } ?>
<?php if ($pendaftar2->sekolah_asal->Visible) { // sekolah_asal ?>
		<th class="<?php echo $pendaftar2->sekolah_asal->HeaderCellClass() ?>"><span id="elh_pendaftar2_sekolah_asal" class="pendaftar2_sekolah_asal"><?php echo $pendaftar2->sekolah_asal->FldCaption() ?></span></th>
<?php } ?>
<?php if ($pendaftar2->nama_lengkap->Visible) { // nama_lengkap ?>
		<th class="<?php echo $pendaftar2->nama_lengkap->HeaderCellClass() ?>"><span id="elh_pendaftar2_nama_lengkap" class="pendaftar2_nama_lengkap"><?php echo $pendaftar2->nama_lengkap->FldCaption() ?></span></th>
<?php } ?>
<?php if ($pendaftar2->jenis_kelamin->Visible) { // jenis_kelamin ?>
		<th class="<?php echo $pendaftar2->jenis_kelamin->HeaderCellClass() ?>"><span id="elh_pendaftar2_jenis_kelamin" class="pendaftar2_jenis_kelamin"><?php echo $pendaftar2->jenis_kelamin->FldCaption() ?></span></th>
<?php } ?>
<?php if ($pendaftar2->zona->Visible) { // zona ?>
		<th class="<?php echo $pendaftar2->zona->HeaderCellClass() ?>"><span id="elh_pendaftar2_zona" class="pendaftar2_zona"><?php echo $pendaftar2->zona->FldCaption() ?></span></th>
<?php } ?>
<?php if ($pendaftar2->nilai_akhir->Visible) { // nilai_akhir ?>
		<th class="<?php echo $pendaftar2->nilai_akhir->HeaderCellClass() ?>"><span id="elh_pendaftar2_nilai_akhir" class="pendaftar2_nilai_akhir"><?php echo $pendaftar2->nilai_akhir->FldCaption() ?></span></th>
<?php } ?>
<?php if ($pendaftar2->status->Visible) { // status ?>
		<th class="<?php echo $pendaftar2->status->HeaderCellClass() ?>"><span id="elh_pendaftar2_status" class="pendaftar2_status"><?php echo $pendaftar2->status->FldCaption() ?></span></th>
<?php } ?>
<?php if ($pendaftar2->persyaratan->Visible) { // persyaratan ?>
		<th class="<?php echo $pendaftar2->persyaratan->HeaderCellClass() ?>"><span id="elh_pendaftar2_persyaratan" class="pendaftar2_persyaratan"><?php echo $pendaftar2->persyaratan->FldCaption() ?></span></th>
<?php } ?>
<?php if ($pendaftar2->catatan->Visible) { // catatan ?>
		<th class="<?php echo $pendaftar2->catatan->HeaderCellClass() ?>"><span id="elh_pendaftar2_catatan" class="pendaftar2_catatan"><?php echo $pendaftar2->catatan->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
<?php
$pendaftar2_delete->RecCnt = 0;
$i = 0;
while (!$pendaftar2_delete->Recordset->EOF) {
	$pendaftar2_delete->RecCnt++;
	$pendaftar2_delete->RowCnt++;

	// Set row properties
	$pendaftar2->ResetAttrs();
	$pendaftar2->RowType = EW_ROWTYPE_VIEW; // View

	// Get the field contents
	$pendaftar2_delete->LoadRowValues($pendaftar2_delete->Recordset);

	// Render row
	$pendaftar2_delete->RenderRow();
?>
	<tr<?php echo $pendaftar2->RowAttributes() ?>>
<?php if ($pendaftar2->nama_ruang->Visible) { // nama_ruang ?>
		<td<?php echo $pendaftar2->nama_ruang->CellAttributes() ?>>
<span id="el<?php echo $pendaftar2_delete->RowCnt ?>_pendaftar2_nama_ruang" class="pendaftar2_nama_ruang">
...
<?php } ?>
<?php if ($pendaftar2->nomor_pendaftaran->Visible) { // nomor_pendaftaran ?>
		<td<?php echo $pendaftar2->nomor_pendaftaran->CellAttributes() ?>>
<span id="el<?php echo $pendaftar2_delete->RowCnt ?>_pendaftar2_nomor_pendaftaran" class="pendaftar2_nomor_pendaftaran">
...
<?php } ?>
<?php if ($pendaftar2->nomor_peserta_ujian_sdmi->Visible) { // nomor_peserta_ujian_sdmi ?>
		<td<?php echo $pendaftar2->nomor_peserta_ujian_sdmi->CellAttributes() ?>>
<span id="el<?php echo $pendaftar2_delete->RowCnt ?>_pendaftar2_nomor_peserta_ujian_sdmi" class="pendaftar2_nomor_peserta_ujian_sdmi">
...
<?php } ?>
<?php if ($pendaftar2->sekolah_asal->Visible) { // sekolah_asal ?>
		<td<?php echo $pendaftar2->sekolah_asal->CellAttributes() ?>>
<span id="el<?php echo $pendaftar2_delete->RowCnt ?>_pendaftar2_sekolah_asal" class="pendaftar2_sekolah_asal">
...
<?php } ?>
<?php if ($pendaftar2->nama_lengkap->Visible) { // nama_lengkap ?>
		<td<?php echo $pendaftar2->nama_lengkap->CellAttributes() ?>>
<span id="el<?php echo $pendaftar2_delete->RowCnt ?>_pendaftar2_nama_lengkap" class="pendaftar2_nama_lengkap">
...
<?php } ?>
<?php if ($pendaftar2->jenis_kelamin->Visible) { // jenis_kelamin ?>
		<td<?php echo $pendaftar2->jenis_kelamin->CellAttributes() ?>>
<span id="el<?php echo $pendaftar2_delete->RowCnt ?>_pendaftar2_jenis_kelamin" class="pendaftar2_jenis_kelamin">
...
<?php } ?>
<?php if ($pendaftar2->zona->Visible) { // zona ?>
		<td<?php echo $pendaftar2->zona->CellAttributes() ?>>
<span id="el<?php echo $pendaftar2_delete->RowCnt ?>_pendaftar2_zona" class="pendaftar2_zona">
...
<?php } ?>
<?php if ($pendaftar2->nilai_akhir->Visible) { // nilai_akhir ?>
		<td<?php echo $pendaftar2->nilai_akhir->CellAttributes() ?>>
<span id="el<?php echo $pendaftar2_delete->RowCnt ?>_pendaftar2_nilai_akhir" class="pendaftar2_nilai_akhir">
...
<?php } ?>
<?php if ($pendaftar2->status->Visible) { // status ?>
		<td<?php echo $pendaftar2->status->CellAttributes() ?>>
<span id="el<?php echo $pendaftar2_delete->RowCnt ?>_pendaftar2_status" class="pendaftar2_status">
...
<?php } ?>
<?php if ($pendaftar2->persyaratan->Visible) { // persyaratan ?>
		<td<?php echo $pendaftar2->persyaratan->CellAttributes() ?>>
<span id="el<?php echo $pendaftar2_delete->RowCnt ?>_pendaftar2_persyaratan" class="pendaftar2_persyaratan">
...
<?php } ?>
<?php if ($pendaftar2->catatan->Visible) { // catatan ?>
		<td<?php echo $pendaftar2->catatan->CellAttributes() ?>>
<span id="el<?php echo $pendaftar2_delete->RowCnt ?>_pendaftar2_catatan" class="pendaftar2_catatan">
...
<?php
	$pendaftar2_delete->Recordset->MoveNext();
}
$pendaftar2_delete->Recordset->Close();
?>
</tbody>
</table>
</div>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $pendaftar2_delete->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
</div>
</form>
<script type="text/javascript">
fpendaftar2delete.Init();
</script>
<?php
$pendaftar2_delete->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$pendaftar2_delete->Page_Terminate();
?>
