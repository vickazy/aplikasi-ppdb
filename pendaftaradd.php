...
$pendaftar_add = NULL; // Initialize page object first

class cpendaftar_add extends cpendaftar {
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "pendaftarview.php")
	...
	function RenderRow() {
		...
		$this->keterangan->ViewCustomAttributes = "";
			...
			$this->nama_ruang->LookupFilters = array();
			ew_AddFilter($sWhereWrk, $sFilterWrk);
			if (!$GLOBALS["pendaftar"]->UserIDAllow("add")) $sWhereWrk = $GLOBALS["ruang"]->AddUserIDFilter($sWhereWrk);
			$this->Lookup_Selecting($this->nama_ruang, $sWhereWrk); // Call Lookup Selecting
			if ($sWhereWrk <> "") $sSqlWrk .= " WHERE " . $sWhereWrk;
			$rswrk = Conn()->Execute($sSqlWrk);
			$arwrk = ($rswrk) ? $rswrk->GetRows() : array();
			...
			$this->nomor_pendaftaran->LookupFilters = array("dx1" => '`nomor_pendaftaran`');
			ew_AddFilter($sWhereWrk, $sFilterWrk);
			if (!$GLOBALS["pendaftar"]->UserIDAllow("add")) $sWhereWrk = $GLOBALS["no_pendaftaran"]->AddUserIDFilter($sWhereWrk);
			$this->Lookup_Selecting($this->nomor_pendaftaran, $sWhereWrk); // Call Lookup Selecting
			if ($sWhereWrk <> "") $sSqlWrk .= " WHERE " . $sWhereWrk;
			$rswrk = Conn()->Execute($sSqlWrk);
			if ($rswrk && !$rswrk->EOF) { // Lookup values found
	...
	function AddRow($rsold = NULL) {
		...
		if ($this->nomor_peserta_ujian_sdmi->CurrentValue <> "") { // Check field with unique index
			$sFilter = "(nomor_peserta_ujian_sdmi = '" . ew_AdjustSql($this->nomor_peserta_ujian_sdmi->CurrentValue, $this->DBID) . "')";
			$rsChk = $this->LoadRs($sFilter);
			if ($rsChk && !$rsChk->EOF) {
...
// Create page object
if (!isset($pendaftar_add)) $pendaftar_add = new cpendaftar_add();

// Page init
$pendaftar_add->Page_Init();

// Page main
$pendaftar_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$pendaftar_add->Page_Render();
?>
...
var CurrentForm = fpendaftaradd = new ew_Form("fpendaftaradd", "add");

// Validate form
fpendaftaradd.Validate = function() {
...
fpendaftaradd.Form_CustomValidate = 
...
fpendaftaradd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Multi-Page
fpendaftaradd.MultiPage = new ew_MultiPage("fpendaftaradd");

// Dynamic selection lists
fpendaftaradd.Lists["x_nama_ruang"] = {"LinkField":"x_nama_ruang","Ajax":true,"AutoFill":false,"DisplayFields":["x_nama_ruang","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"ruang"};
fpendaftaradd.Lists["x_nama_ruang"].Data = "<?php echo $pendaftar_add->nama_ruang->LookupFilterQuery(FALSE, "add") ?>";
fpendaftaradd.Lists["x_nomor_pendaftaran"] = {"LinkField":"x_nomor_pendaftaran","Ajax":true,"AutoFill":false,"DisplayFields":["x_nomor_pendaftaran","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"no_pendaftaran"};
fpendaftaradd.Lists["x_nomor_pendaftaran"].Data = "<?php echo $pendaftar_add->nomor_pendaftaran->LookupFilterQuery(FALSE, "add") ?>";
fpendaftaradd.Lists["x_nomor_peserta_ujian_sdmi"] = {"LinkField":"x_nopes","Ajax":true,"AutoFill":true,"DisplayFields":["x_nopes","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"db_pd"};
fpendaftaradd.Lists["x_nomor_peserta_ujian_sdmi"].Data = "<?php echo $pendaftar_add->nomor_peserta_ujian_sdmi->LookupFilterQuery(FALSE, "add") ?>";
fpendaftaradd.Lists["x_jenis_kelamin"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fpendaftaradd.Lists["x_jenis_kelamin"].Options = <?php echo json_encode($pendaftar_add->jenis_kelamin->Options()) ?>;
fpendaftaradd.Lists["x_agama"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fpendaftaradd.Lists["x_agama"].Options = <?php echo json_encode($pendaftar_add->agama->Options()) ?>;
fpendaftaradd.Lists["x_kecamatan"] = {"LinkField":"x_id_kec","Ajax":true,"AutoFill":true,"DisplayFields":["x_nama_kec","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"kecamatan"};
fpendaftaradd.Lists["x_kecamatan"].Data = "<?php echo $pendaftar_add->kecamatan->LookupFilterQuery(FALSE, "add") ?>";
fpendaftaradd.Lists["x_bonus_prestasi"] = {"LinkField":"x_id_bonus","Ajax":true,"AutoFill":true,"DisplayFields":["x_bonus","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"bonus"};
fpendaftaradd.Lists["x_bonus_prestasi"].Data = "<?php echo $pendaftar_add->bonus_prestasi->LookupFilterQuery(FALSE, "add") ?>";
fpendaftaradd.Lists["x_kepemilikan_ijasah_mda"] = {"LinkField":"x_id_mda","Ajax":true,"AutoFill":true,"DisplayFields":["x_mda","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"mda"};
fpendaftaradd.Lists["x_kepemilikan_ijasah_mda"].Data = "<?php echo $pendaftar_add->kepemilikan_ijasah_mda->LookupFilterQuery(FALSE, "add") ?>";
fpendaftaradd.Lists["x_persyaratan"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fpendaftaradd.Lists["x_persyaratan"].Options = <?php echo json_encode($pendaftar_add->persyaratan->Options()) ?>;
...
<?php $pendaftar_add->ShowPageHeader(); ?>
<?php
$pendaftar_add->ShowMessage();
?>
<form name="fpendaftaradd" id="fpendaftaradd" class="<?php echo $pendaftar_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($pendaftar_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $pendaftar_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="pendaftar">
<input type="hidden" name="a_add" id="a_add" value="A">
<input type="hidden" name="modal" value="<?php echo intval($pendaftar_add->IsModal) ?>">
<div class="ewMultiPage"><!-- multi-page -->
<div class="nav-tabs-custom" id="pendaftar_add"><!-- multi-page .nav-tabs-custom -->
	<ul class="nav<?php echo $pendaftar_add->MultiPages->NavStyle() ?>">
		<li<?php echo $pendaftar_add->MultiPages->TabStyle("1") ?>><a href="#tab_pendaftar1" data-toggle="tab"><?php echo $pendaftar->PageCaption(1) ?></a></li>
		<li<?php echo $pendaftar_add->MultiPages->TabStyle("2") ?>><a href="#tab_pendaftar2" data-toggle="tab"><?php echo $pendaftar->PageCaption(2) ?></a></li>
		<li<?php echo $pendaftar_add->MultiPages->TabStyle("3") ?>><a href="#tab_pendaftar3" data-toggle="tab"><?php echo $pendaftar->PageCaption(3) ?></a></li>
	</ul>
	<div class="tab-content"><!-- multi-page .nav-tabs-custom .tab-content -->
		<div class="tab-pane<?php echo $pendaftar_add->MultiPages->PageStyle("1") ?>" id="tab_pendaftar1"><!-- multi-page .tab-pane -->
<div class="ewAddDiv"><!-- page* -->
<?php if ($pendaftar->nama_ruang->Visible) { // nama_ruang ?>
	<div id="r_nama_ruang" class="form-group">
		<label id="elh_pendaftar_nama_ruang" for="x_nama_ruang" class="<?php echo $pendaftar_add->LeftColumnClass ?>"><?php echo $pendaftar->nama_ruang->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $pendaftar_add->RightColumnClass ?>"><div<?php echo $pendaftar->nama_ruang->CellAttributes() ?>>
<?php if (!$Security->IsAdmin() && $Security->IsLoggedIn() && !$pendaftar->UserIDAllow("add")) { // Non system admin ?>
...
<?php if ($pendaftar->nomor_pendaftaran->Visible) { // nomor_pendaftaran ?>
	<div id="r_nomor_pendaftaran" class="form-group">
		<label id="elh_pendaftar_nomor_pendaftaran" for="x_nomor_pendaftaran" class="<?php echo $pendaftar_add->LeftColumnClass ?>"><?php echo $pendaftar->nomor_pendaftaran->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $pendaftar_add->RightColumnClass ?>"><div<?php echo $pendaftar->nomor_pendaftaran->CellAttributes() ?>>
...
<?php if ($pendaftar->nomor_peserta_ujian_sdmi->Visible) { // nomor_peserta_ujian_sdmi ?>
	<div id="r_nomor_peserta_ujian_sdmi" class="form-group">
		<label id="elh_pendaftar_nomor_peserta_ujian_sdmi" for="x_nomor_peserta_ujian_sdmi" class="<?php echo $pendaftar_add->LeftColumnClass ?>"><?php echo $pendaftar->nomor_peserta_ujian_sdmi->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $pendaftar_add->RightColumnClass ?>"><div<?php echo $pendaftar->nomor_peserta_ujian_sdmi->CellAttributes() ?>>
...
<input type="hidden" name="ln_x_nomor_peserta_ujian_sdmi" id="ln_x_nomor_peserta_ujian_sdmi" value="x_sekolah_asal,x_nama_lengkap,x_nisn,x_n_ind,x_n_mat,x_n_ipa,x_jumlah_nilai_usum,x_nama_ayah">
</span>
...
<?php if ($pendaftar->sekolah_asal->Visible) { // sekolah_asal ?>
	<div id="r_sekolah_asal" class="form-group">
		<label id="elh_pendaftar_sekolah_asal" for="x_sekolah_asal" class="<?php echo $pendaftar_add->LeftColumnClass ?>"><?php echo $pendaftar->sekolah_asal->FldCaption() ?></label>
		<div class="<?php echo $pendaftar_add->RightColumnClass ?>"><div<?php echo $pendaftar->sekolah_asal->CellAttributes() ?>>
...
<?php if ($pendaftar->nama_lengkap->Visible) { // nama_lengkap ?>
	<div id="r_nama_lengkap" class="form-group">
		<label id="elh_pendaftar_nama_lengkap" for="x_nama_lengkap" class="<?php echo $pendaftar_add->LeftColumnClass ?>"><?php echo $pendaftar->nama_lengkap->FldCaption() ?></label>
		<div class="<?php echo $pendaftar_add->RightColumnClass ?>"><div<?php echo $pendaftar->nama_lengkap->CellAttributes() ?>>
...
<?php if ($pendaftar->nik->Visible) { // nik ?>
	<div id="r_nik" class="form-group">
		<label id="elh_pendaftar_nik" for="x_nik" class="<?php echo $pendaftar_add->LeftColumnClass ?>"><?php echo $pendaftar->nik->FldCaption() ?></label>
		<div class="<?php echo $pendaftar_add->RightColumnClass ?>"><div<?php echo $pendaftar->nik->CellAttributes() ?>>
...
<?php if ($pendaftar->nisn->Visible) { // nisn ?>
	<div id="r_nisn" class="form-group">
		<label id="elh_pendaftar_nisn" for="x_nisn" class="<?php echo $pendaftar_add->LeftColumnClass ?>"><?php echo $pendaftar->nisn->FldCaption() ?></label>
		<div class="<?php echo $pendaftar_add->RightColumnClass ?>"><div<?php echo $pendaftar->nisn->CellAttributes() ?>>
...
<?php if ($pendaftar->tempat_lahir->Visible) { // tempat_lahir ?>
	<div id="r_tempat_lahir" class="form-group">
		<label id="elh_pendaftar_tempat_lahir" for="x_tempat_lahir" class="<?php echo $pendaftar_add->LeftColumnClass ?>"><?php echo $pendaftar->tempat_lahir->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $pendaftar_add->RightColumnClass ?>"><div<?php echo $pendaftar->tempat_lahir->CellAttributes() ?>>
...
<?php if ($pendaftar->tanggal_lahir->Visible) { // tanggal_lahir ?>
	<div id="r_tanggal_lahir" class="form-group">
		<label id="elh_pendaftar_tanggal_lahir" for="x_tanggal_lahir" class="<?php echo $pendaftar_add->LeftColumnClass ?>"><?php echo $pendaftar->tanggal_lahir->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $pendaftar_add->RightColumnClass ?>"><div<?php echo $pendaftar->tanggal_lahir->CellAttributes() ?>>
...
<script type="text/javascript">
ew_CreateDateTimePicker("fpendaftaradd", "x_tanggal_lahir", {"ignoreReadonly":true,"useCurrent":false,"format":7});
</script>
<?php } ?>
</span>
...
<?php if ($pendaftar->jenis_kelamin->Visible) { // jenis_kelamin ?>
	<div id="r_jenis_kelamin" class="form-group">
		<label id="elh_pendaftar_jenis_kelamin" class="<?php echo $pendaftar_add->LeftColumnClass ?>"><?php echo $pendaftar->jenis_kelamin->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $pendaftar_add->RightColumnClass ?>"><div<?php echo $pendaftar->jenis_kelamin->CellAttributes() ?>>
...
<?php if ($pendaftar->agama->Visible) { // agama ?>
	<div id="r_agama" class="form-group">
		<label id="elh_pendaftar_agama" for="x_agama" class="<?php echo $pendaftar_add->LeftColumnClass ?>"><?php echo $pendaftar->agama->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $pendaftar_add->RightColumnClass ?>"><div<?php echo $pendaftar->agama->CellAttributes() ?>>
...
<?php if ($pendaftar->alamat->Visible) { // alamat ?>
	<div id="r_alamat" class="form-group">
		<label id="elh_pendaftar_alamat" for="x_alamat" class="<?php echo $pendaftar_add->LeftColumnClass ?>"><?php echo $pendaftar->alamat->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $pendaftar_add->RightColumnClass ?>"><div<?php echo $pendaftar->alamat->CellAttributes() ?>>
...
<?php if ($pendaftar->kecamatan->Visible) { // kecamatan ?>
	<div id="r_kecamatan" class="form-group">
		<label id="elh_pendaftar_kecamatan" for="x_kecamatan" class="<?php echo $pendaftar_add->LeftColumnClass ?>"><?php echo $pendaftar->kecamatan->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $pendaftar_add->RightColumnClass ?>"><div<?php echo $pendaftar->kecamatan->CellAttributes() ?>>
...
<?php if ($pendaftar->zona->Visible) { // zona ?>
	<div id="r_zona" class="form-group">
		<label id="elh_pendaftar_zona" for="x_zona" class="<?php echo $pendaftar_add->LeftColumnClass ?>"><?php echo $pendaftar->zona->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $pendaftar_add->RightColumnClass ?>"><div<?php echo $pendaftar->zona->CellAttributes() ?>>
<span id="el_pendaftar_zona">
<input type="text" data-table="pendaftar" data-field="x_zona" data-page="1" name="x_zona" id="x_zona" size="30" maxlength="50" placeholder="<?php echo ew_HtmlEncode($pendaftar->zona->getPlaceHolder()) ?>" value="<?php echo $pendaftar->zona->EditValue ?>"<?php echo $pendaftar->zona->EditAttributes() ?>readonly>
</span>
...
<?php if ($pendaftar->nama_ayah->Visible) { // nama_ayah ?>
	<div id="r_nama_ayah" class="form-group">
		<label id="elh_pendaftar_nama_ayah" for="x_nama_ayah" class="<?php echo $pendaftar_add->LeftColumnClass ?>"><?php echo $pendaftar->nama_ayah->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $pendaftar_add->RightColumnClass ?>"><div<?php echo $pendaftar->nama_ayah->CellAttributes() ?>>
...
<?php if ($pendaftar->nama_ibu->Visible) { // nama_ibu ?>
	<div id="r_nama_ibu" class="form-group">
		<label id="elh_pendaftar_nama_ibu" for="x_nama_ibu" class="<?php echo $pendaftar_add->LeftColumnClass ?>"><?php echo $pendaftar->nama_ibu->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $pendaftar_add->RightColumnClass ?>"><div<?php echo $pendaftar->nama_ibu->CellAttributes() ?>>
...
<?php if ($pendaftar->nama_wali->Visible) { // nama_wali ?>
	<div id="r_nama_wali" class="form-group">
		<label id="elh_pendaftar_nama_wali" for="x_nama_wali" class="<?php echo $pendaftar_add->LeftColumnClass ?>"><?php echo $pendaftar->nama_wali->FldCaption() ?></label>
		<div class="<?php echo $pendaftar_add->RightColumnClass ?>"><div<?php echo $pendaftar->nama_wali->CellAttributes() ?>>
...
<?php } ?>
		...
		<div class="tab-pane<?php echo $pendaftar_add->MultiPages->PageStyle("2") ?>" id="tab_pendaftar2"><!-- multi-page .tab-pane -->
<div class="ewAddDiv"><!-- page* -->
<?php if ($pendaftar->n_ind->Visible) { // n_ind ?>
	<div id="r_n_ind" class="form-group">
		<label id="elh_pendaftar_n_ind" for="x_n_ind" class="<?php echo $pendaftar_add->LeftColumnClass ?>"><?php echo $pendaftar->n_ind->FldCaption() ?></label>
		<div class="<?php echo $pendaftar_add->RightColumnClass ?>"><div<?php echo $pendaftar->n_ind->CellAttributes() ?>>
<span id="el_pendaftar_n_ind">
<input type="text" data-table="pendaftar" data-field="x_n_ind" data-page="2" name="x_n_ind" id="x_n_ind" size="30" placeholder="<?php echo ew_HtmlEncode($pendaftar->n_ind->getPlaceHolder()) ?>" value="<?php echo $pendaftar->n_ind->EditValue ?>"<?php echo $pendaftar->n_ind->EditAttributes() ?>>
</span>
...
<?php if ($pendaftar->n_mat->Visible) { // n_mat ?>
	<div id="r_n_mat" class="form-group">
		<label id="elh_pendaftar_n_mat" for="x_n_mat" class="<?php echo $pendaftar_add->LeftColumnClass ?>"><?php echo $pendaftar->n_mat->FldCaption() ?></label>
		<div class="<?php echo $pendaftar_add->RightColumnClass ?>"><div<?php echo $pendaftar->n_mat->CellAttributes() ?>>
<span id="el_pendaftar_n_mat">
<input type="text" data-table="pendaftar" data-field="x_n_mat" data-page="2" name="x_n_mat" id="x_n_mat" size="30" placeholder="<?php echo ew_HtmlEncode($pendaftar->n_mat->getPlaceHolder()) ?>" value="<?php echo $pendaftar->n_mat->EditValue ?>"<?php echo $pendaftar->n_mat->EditAttributes() ?>>
</span>
...
<?php if ($pendaftar->n_ipa->Visible) { // n_ipa ?>
	<div id="r_n_ipa" class="form-group">
		<label id="elh_pendaftar_n_ipa" for="x_n_ipa" class="<?php echo $pendaftar_add->LeftColumnClass ?>"><?php echo $pendaftar->n_ipa->FldCaption() ?></label>
		<div class="<?php echo $pendaftar_add->RightColumnClass ?>"><div<?php echo $pendaftar->n_ipa->CellAttributes() ?>>
<span id="el_pendaftar_n_ipa">
<input type="text" data-table="pendaftar" data-field="x_n_ipa" data-page="2" name="x_n_ipa" id="x_n_ipa" size="30" placeholder="<?php echo ew_HtmlEncode($pendaftar->n_ipa->getPlaceHolder()) ?>" value="<?php echo $pendaftar->n_ipa->EditValue ?>"<?php echo $pendaftar->n_ipa->EditAttributes() ?>>
</span>
...
<?php if ($pendaftar->jumlah_nilai_usum->Visible) { // jumlah_nilai_usum ?>
	<div id="r_jumlah_nilai_usum" class="form-group">
		<label id="elh_pendaftar_jumlah_nilai_usum" for="x_jumlah_nilai_usum" class="<?php echo $pendaftar_add->LeftColumnClass ?>"><?php echo $pendaftar->jumlah_nilai_usum->FldCaption() ?></label>
		<div class="<?php echo $pendaftar_add->RightColumnClass ?>"><div<?php echo $pendaftar->jumlah_nilai_usum->CellAttributes() ?>>
<span id="el_pendaftar_jumlah_nilai_usum">
<input type="text" data-table="pendaftar" data-field="x_jumlah_nilai_usum" data-page="2" name="x_jumlah_nilai_usum" id="x_jumlah_nilai_usum" size="30" maxlength="50" placeholder="<?php echo ew_HtmlEncode($pendaftar->jumlah_nilai_usum->getPlaceHolder()) ?>" value="<?php echo $pendaftar->jumlah_nilai_usum->EditValue ?>"<?php echo $pendaftar->jumlah_nilai_usum->EditAttributes() ?>>
</span>
...
<?php if ($pendaftar->bonus_prestasi->Visible) { // bonus_prestasi ?>
	<div id="r_bonus_prestasi" class="form-group">
		<label id="elh_pendaftar_bonus_prestasi" for="x_bonus_prestasi" class="<?php echo $pendaftar_add->LeftColumnClass ?>"><?php echo $pendaftar->bonus_prestasi->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $pendaftar_add->RightColumnClass ?>"><div<?php echo $pendaftar->bonus_prestasi->CellAttributes() ?>>
...
<?php if ($pendaftar->nama_prestasi->Visible) { // nama_prestasi ?>
	<div id="r_nama_prestasi" class="form-group">
		<label id="elh_pendaftar_nama_prestasi" for="x_nama_prestasi" class="<?php echo $pendaftar_add->LeftColumnClass ?>"><?php echo $pendaftar->nama_prestasi->FldCaption() ?></label>
		<div class="<?php echo $pendaftar_add->RightColumnClass ?>"><div<?php echo $pendaftar->nama_prestasi->CellAttributes() ?>>
...
<?php } ?>
<?php if ($pendaftar->jumlah_bonus_prestasi->Visible) { // jumlah_bonus_prestasi ?>
	<div id="r_jumlah_bonus_prestasi" class="form-group">
		<label id="elh_pendaftar_jumlah_bonus_prestasi" class="<?php echo $pendaftar_add->LeftColumnClass ?>"><?php echo $pendaftar->jumlah_bonus_prestasi->FldCaption() ?></label>
		<div class="<?php echo $pendaftar_add->RightColumnClass ?>"><div<?php echo $pendaftar->jumlah_bonus_prestasi->CellAttributes() ?>>
<span id="el_pendaftar_jumlah_bonus_prestasi">
<input type="text" data-table="pendaftar" data-field="x_jumlah_bonus_prestasi" data-page="2" name="x_jumlah_bonus_prestasi" id="x_jumlah_bonus_prestasi" size="30" maxlength="50" placeholder="<?php echo ew_HtmlEncode($pendaftar->jumlah_bonus_prestasi->getPlaceHolder()) ?>" value="<?php echo $pendaftar->jumlah_bonus_prestasi->EditValue ?>"<?php echo $pendaftar->jumlah_bonus_prestasi->EditAttributes() ?>readonly>
</span>
<?php echo $pendaftar->jumlah_bonus_prestasi->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($pendaftar->kepemilikan_ijasah_mda->Visible) { // kepemilikan_ijasah_mda ?>
	<div id="r_kepemilikan_ijasah_mda" class="form-group">
		<label id="elh_pendaftar_kepemilikan_ijasah_mda" class="<?php echo $pendaftar_add->LeftColumnClass ?>"><?php echo $pendaftar->kepemilikan_ijasah_mda->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $pendaftar_add->RightColumnClass ?>"><div<?php echo $pendaftar->kepemilikan_ijasah_mda->CellAttributes() ?>>
...
<?php } ?>
<?php if ($pendaftar->nilai_mda->Visible) { // nilai_mda ?>
	<div id="r_nilai_mda" class="form-group">
		<label id="elh_pendaftar_nilai_mda" class="<?php echo $pendaftar_add->LeftColumnClass ?>"><?php echo $pendaftar->nilai_mda->FldCaption() ?></label>
		<div class="<?php echo $pendaftar_add->RightColumnClass ?>"><div<?php echo $pendaftar->nilai_mda->CellAttributes() ?>>
<span id="el_pendaftar_nilai_mda">
<input type="text" data-table="pendaftar" data-field="x_nilai_mda" data-page="2" name="x_nilai_mda" id="x_nilai_mda" size="30" maxlength="50" placeholder="<?php echo ew_HtmlEncode($pendaftar->nilai_mda->getPlaceHolder()) ?>" value="<?php echo $pendaftar->nilai_mda->EditValue ?>"<?php echo $pendaftar->nilai_mda->EditAttributes() ?>readonly>
</span>
<?php echo $pendaftar->nilai_mda->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($pendaftar->nilai_akhir->Visible) { // nilai_akhir ?>
	<div id="r_nilai_akhir" class="form-group">
		<label id="elh_pendaftar_nilai_akhir" for="x_nilai_akhir" class="<?php echo $pendaftar_add->LeftColumnClass ?>"><?php echo $pendaftar->nilai_akhir->FldCaption() ?></label>
		<div class="<?php echo $pendaftar_add->RightColumnClass ?>"><div<?php echo $pendaftar->nilai_akhir->CellAttributes() ?>>
...
<?php } ?>
		...
		<div class="tab-pane<?php echo $pendaftar_add->MultiPages->PageStyle("3") ?>" id="tab_pendaftar3"><!-- multi-page .tab-pane -->
<div class="ewAddDiv"><!-- page* -->
<?php if ($pendaftar->persyaratan->Visible) { // persyaratan ?>
	<div id="r_persyaratan" class="form-group">
		<label id="elh_pendaftar_persyaratan" class="<?php echo $pendaftar_add->LeftColumnClass ?>"><?php echo $pendaftar->persyaratan->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $pendaftar_add->RightColumnClass ?>"><div<?php echo $pendaftar->persyaratan->CellAttributes() ?>>
...
<?php if ($pendaftar->catatan->Visible) { // catatan ?>
	<div id="r_catatan" class="form-group">
		<label id="elh_pendaftar_catatan" for="x_catatan" class="<?php echo $pendaftar_add->LeftColumnClass ?>"><?php echo $pendaftar->catatan->FldCaption() ?></label>
		<div class="<?php echo $pendaftar_add->RightColumnClass ?>"><div<?php echo $pendaftar->catatan->CellAttributes() ?>>
...
<?php if (!$pendaftar_add->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $pendaftar_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $pendaftar_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
