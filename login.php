...
class clogin extends cruang {
	...
	function __construct() {
		...
		if (!isset($GLOBALS["ruang"])) $GLOBALS["ruang"] = &$this;
...
<style type="text/css">
 body {
  ...
  -moz-animation: color 5s linear  0s infinite alternate running;
	...
	background-image: url(phpimages/ppdb.png);
	background-repeat: repeat;
    background-position: center;
    background-size: cover; 
}
@-webkit-keyframes color {
     0% { background-color: #26247a; }
     25% { background-color: #050354; }
 }
 @-moz-keyframes color {
     0% { background-color: #26247a; }
     25% { background-color: #050354; }
  ...
  <nav class="navbar navbar-inverse navbar-fixed-top">
    <div class="container-fluid">
      <div class="navbar-header">
        ...
        <a class="navbar-brand page-scroll" href="index.php">PPDB</a></div>
      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        <ul class="nav navbar-nav navbar-right">
          <li><a class="page-scroll" href="index.php">Home</a></li>
          <li><a class="page-scroll" href="index.php#services">Login</a></li>          
          <li><a class="page-scroll" href="index.php#about">Zonasi</a></li>
        </ul>
      </div>
    </div><!-- /.container-fluid -->
  </nav>
