...
define("EW_PROJECT_NAME", "pepedebe", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME, TRUE); // Config file name
define("EW_PROJECT_ID", "{27E315CC-B02A-4AE4-92E7-B346521044C4}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'IwLJ3OusBWGotvFH', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/pepedebe.css", TRUE); // Project stylesheet file name
...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "pepedebe", "qs" => "`", "qe" => "`");
$EW_CONN[0] = &$EW_CONN["DB"];
$EW_CONN["pepedebe1"] = array("conn" => NULL, "id" => "pepedebe1", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "pepedebe", "qs" => "`", "qe" => "`", "new" => TRUE);
$EW_CONN[1] = &$EW_CONN["pepedebe1"];
...
define("EW_ADMIN_PASSWORD", "ppdb", TRUE); // Administrator password
...
define("EW_USER_TABLE", "`ruang`", TRUE);
define("EW_USER_NAME_FILTER", "(`nama_ruang` = '%u')", TRUE);
define("EW_USER_ID_FILTER", "(`nama_ruang` = '%u')", TRUE);
