...
//
// Table class for rekap
//
class crekap extends cTable {
	var $id_pendaftar;
	var $nama_ruang;
	...
	function __construct() {
		...
		// id_pendaftar
		$this->id_pendaftar = new cField('rekap', 'rekap', 'x_id_pendaftar', 'id_pendaftar', '`id_pendaftar`', '`id_pendaftar`', 3, -1, FALSE, '`id_pendaftar`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// nama_ruang
		$this->nama_ruang = new cField('rekap', 'rekap', 'x_nama_ruang', 'nama_ruang', '`nama_ruang`', '`nama_ruang`', 200, -1, FALSE, '`nama_ruang`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->nama_ruang->Sortable = TRUE; // Allow sort
		$this->fields['nama_ruang'] = &$this->nama_ruang;

		// nomor_pendaftaran
		$this->nomor_pendaftaran = new cField('rekap', 'rekap', 'x_nomor_pendaftaran', 'nomor_pendaftaran', '`nomor_pendaftaran`', '`nomor_pendaftaran`', 200, -1, FALSE, '`nomor_pendaftaran`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->nomor_peserta_ujian_sdmi = new cField('rekap', 'rekap', 'x_nomor_peserta_ujian_sdmi', 'nomor_peserta_ujian_sdmi', '`nomor_peserta_ujian_sdmi`', '`nomor_peserta_ujian_sdmi`', 200, -1, FALSE, '`nomor_peserta_ujian_sdmi`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->nomor_peserta_ujian_sdmi->Sortable = TRUE; // Allow sort
		$this->fields['nomor_peserta_ujian_sdmi'] = &$this->nomor_peserta_ujian_sdmi;

		// sekolah_asal
		$this->sekolah_asal = new cField('rekap', 'rekap', 'x_sekolah_asal', 'sekolah_asal', '`sekolah_asal`', '`sekolah_asal`', 200, -1, FALSE, '`sekolah_asal`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->sekolah_asal->Sortable = TRUE; // Allow sort
		$this->fields['sekolah_asal'] = &$this->sekolah_asal;

		// nama_lengkap
		$this->nama_lengkap = new cField('rekap', 'rekap', 'x_nama_lengkap', 'nama_lengkap', '`nama_lengkap`', '`nama_lengkap`', 200, -1, FALSE, '`nama_lengkap`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->nama_lengkap->Sortable = TRUE; // Allow sort
		$this->fields['nama_lengkap'] = &$this->nama_lengkap;

		// nisn
		$this->nisn = new cField('rekap', 'rekap', 'x_nisn', 'nisn', '`nisn`', '`nisn`', 200, -1, FALSE, '`nisn`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->nisn->Sortable = TRUE; // Allow sort
		$this->fields['nisn'] = &$this->nisn;

		// tempat_lahir
		$this->tempat_lahir = new cField('rekap', 'rekap', 'x_tempat_lahir', 'tempat_lahir', '`tempat_lahir`', '`tempat_lahir`', 200, -1, FALSE, '`tempat_lahir`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->tempat_lahir->Sortable = TRUE; // Allow sort
		$this->fields['tempat_lahir'] = &$this->tempat_lahir;

		// tanggal_lahir
		$this->tanggal_lahir = new cField('rekap', 'rekap', 'x_tanggal_lahir', 'tanggal_lahir', '`tanggal_lahir`', '`tanggal_lahir`', 200, -1, FALSE, '`tanggal_lahir`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->tanggal_lahir->Sortable = TRUE; // Allow sort
		$this->fields['tanggal_lahir'] = &$this->tanggal_lahir;

		// jenis_kelamin
		$this->jenis_kelamin = new cField('rekap', 'rekap', 'x_jenis_kelamin', 'jenis_kelamin', '`jenis_kelamin`', '`jenis_kelamin`', 200, -1, FALSE, '`jenis_kelamin`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->jenis_kelamin->Sortable = TRUE; // Allow sort
		$this->fields['jenis_kelamin'] = &$this->jenis_kelamin;

		// agama
		$this->agama = new cField('rekap', 'rekap', 'x_agama', 'agama', '`agama`', '`agama`', 200, -1, FALSE, '`agama`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->agama->Sortable = TRUE; // Allow sort
		$this->fields['agama'] = &$this->agama;

		// kecamatan
		$this->kecamatan = new cField('rekap', 'rekap', 'x_kecamatan', 'kecamatan', '`kecamatan`', '`kecamatan`', 200, -1, FALSE, '`kecamatan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->kecamatan->Sortable = TRUE; // Allow sort
		$this->fields['kecamatan'] = &$this->kecamatan;

		// zona
		$this->zona = new cField('rekap', 'rekap', 'x_zona', 'zona', '`zona`', '`zona`', 200, -1, FALSE, '`zona`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->zona->Sortable = TRUE; // Allow sort
		$this->fields['zona'] = &$this->zona;

		// jumlah_nilai_usum
		$this->jumlah_nilai_usum = new cField('rekap', 'rekap', 'x_jumlah_nilai_usum', 'jumlah_nilai_usum', '`jumlah_nilai_usum`', '`jumlah_nilai_usum`', 200, -1, FALSE, '`jumlah_nilai_usum`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// bonus_prestasi
		$this->bonus_prestasi = new cField('rekap', 'rekap', 'x_bonus_prestasi', 'bonus_prestasi', '`bonus_prestasi`', '`bonus_prestasi`', 200, -1, FALSE, '`bonus_prestasi`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->bonus_prestasi->Sortable = TRUE; // Allow sort
		$this->fields['bonus_prestasi'] = &$this->bonus_prestasi;

		// nama_prestasi
		$this->nama_prestasi = new cField('rekap', 'rekap', 'x_nama_prestasi', 'nama_prestasi', '`nama_prestasi`', '`nama_prestasi`', 200, -1, FALSE, '`nama_prestasi`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->nama_prestasi->Sortable = TRUE; // Allow sort
		$this->fields['nama_prestasi'] = &$this->nama_prestasi;

		// jumlah_bonus_prestasi
		$this->jumlah_bonus_prestasi = new cField('rekap', 'rekap', 'x_jumlah_bonus_prestasi', 'jumlah_bonus_prestasi', '`jumlah_bonus_prestasi`', '`jumlah_bonus_prestasi`', 200, -1, FALSE, '`jumlah_bonus_prestasi`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->kepemilikan_ijasah_mda = new cField('rekap', 'rekap', 'x_kepemilikan_ijasah_mda', 'kepemilikan_ijasah_mda', '`kepemilikan_ijasah_mda`', '`kepemilikan_ijasah_mda`', 200, -1, FALSE, '`kepemilikan_ijasah_mda`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->kepemilikan_ijasah_mda->Sortable = TRUE; // Allow sort
		$this->fields['kepemilikan_ijasah_mda'] = &$this->kepemilikan_ijasah_mda;

		// nilai_mda
		$this->nilai_mda = new cField('rekap', 'rekap', 'x_nilai_mda', 'nilai_mda', '`nilai_mda`', '`nilai_mda`', 200, -1, FALSE, '`nilai_mda`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// nilai_akhir
		$this->nilai_akhir = new cField('rekap', 'rekap', 'x_nilai_akhir', 'nilai_akhir', '`nilai_akhir`', '`nilai_akhir`', 200, -1, FALSE, '`nilai_akhir`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// nama_ayah
		$this->nama_ayah = new cField('rekap', 'rekap', 'x_nama_ayah', 'nama_ayah', '`nama_ayah`', '`nama_ayah`', 200, -1, FALSE, '`nama_ayah`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->nama_ayah->Sortable = TRUE; // Allow sort
		$this->fields['nama_ayah'] = &$this->nama_ayah;

		// nama_ibu
		$this->nama_ibu = new cField('rekap', 'rekap', 'x_nama_ibu', 'nama_ibu', '`nama_ibu`', '`nama_ibu`', 200, -1, FALSE, '`nama_ibu`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->nama_ibu->Sortable = TRUE; // Allow sort
		$this->fields['nama_ibu'] = &$this->nama_ibu;

		// nama_wali
		$this->nama_wali = new cField('rekap', 'rekap', 'x_nama_wali', 'nama_wali', '`nama_wali`', '`nama_wali`', 200, -1, FALSE, '`nama_wali`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->nama_wali->Sortable = TRUE; // Allow sort
		$this->fields['nama_wali'] = &$this->nama_wali;

		// status
		$this->status = new cField('rekap', 'rekap', 'x_status', 'status', '`status`', '`status`', 200, -1, FALSE, '`status`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->status->Sortable = TRUE; // Allow sort
		$this->fields['status'] = &$this->status;

		// persyaratan
		$this->persyaratan = new cField('rekap', 'rekap', 'x_persyaratan', 'persyaratan', '`persyaratan`', '`persyaratan`', 200, -1, FALSE, '`persyaratan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->persyaratan->Sortable = TRUE; // Allow sort
		$this->fields['persyaratan'] = &$this->persyaratan;

		// keterangan
		$this->keterangan = new cField('rekap', 'rekap', 'x_keterangan', 'keterangan', '`keterangan`', '`keterangan`', 200, -1, FALSE, '`keterangan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->keterangan->Sortable = TRUE; // Allow sort
		$this->fields['keterangan'] = &$this->keterangan;

		// catatan
		$this->catatan = new cField('rekap', 'rekap', 'x_catatan', 'catatan', '`catatan`', '`catatan`', 201, -1, FALSE, '`catatan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->catatan->Sortable = TRUE; // Allow sort
		$this->fields['catatan'] = &$this->catatan;

		// n_ind
		$this->n_ind = new cField('rekap', 'rekap', 'x_n_ind', 'n_ind', '`n_ind`', '`n_ind`', 200, -1, FALSE, '`n_ind`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// n_mat
		$this->n_mat = new cField('rekap', 'rekap', 'x_n_mat', 'n_mat', '`n_mat`', '`n_mat`', 200, -1, FALSE, '`n_mat`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// n_ipa
		$this->n_ipa = new cField('rekap', 'rekap', 'x_n_ipa', 'n_ipa', '`n_ipa`', '`n_ipa`', 200, -1, FALSE, '`n_ipa`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`rekap`";
	}
	...
	function GetModalCaption($pageName) {
		global $Language;
		if ($pageName == "rekapview.php")
			return $Language->Phrase("View");
		elseif ($pageName == "rekapedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "rekapadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("rekapview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("rekapview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "rekapadd.php?" . $this->UrlParm($parm);
		else
			$url = "rekapadd.php";
		return $this->AddMasterUrl($url);
	}
	...
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("rekapedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("rekapadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("rekapdelete.php", $this->UrlParm());
	}
