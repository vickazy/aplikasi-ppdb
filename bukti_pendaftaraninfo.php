...
//
// Table class for bukti_pendaftaran
//
class cbukti_pendaftaran extends cTable {
	var $nama_ruang;
	...
	function __construct() {
		...
		$this->TableVar = 'bukti_pendaftaran';
		$this->TableName = 'bukti_pendaftaran';
		$this->TableType = 'VIEW';
		...
		// nama_ruang
		$this->nama_ruang = new cField('bukti_pendaftaran', 'bukti_pendaftaran', 'x_nama_ruang', 'nama_ruang', '`nama_ruang`', '`nama_ruang`', 200, -1, FALSE, '`nama_ruang`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// nomor_pendaftaran
		$this->nomor_pendaftaran = new cField('bukti_pendaftaran', 'bukti_pendaftaran', 'x_nomor_pendaftaran', 'nomor_pendaftaran', '`nomor_pendaftaran`', '`nomor_pendaftaran`', 200, -1, FALSE, '`nomor_pendaftaran`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->nomor_peserta_ujian_sdmi = new cField('bukti_pendaftaran', 'bukti_pendaftaran', 'x_nomor_peserta_ujian_sdmi', 'nomor_peserta_ujian_sdmi', '`nomor_peserta_ujian_sdmi`', '`nomor_peserta_ujian_sdmi`', 200, -1, FALSE, '`EV__nomor_peserta_ujian_sdmi`', TRUE, TRUE, TRUE, 'FORMATTED TEXT', 'TEXT');
		$this->nomor_peserta_ujian_sdmi->Sortable = TRUE; // Allow sort
		$this->fields['nomor_peserta_ujian_sdmi'] = &$this->nomor_peserta_ujian_sdmi;

		// nama_lengkap
		$this->nama_lengkap = new cField('bukti_pendaftaran', 'bukti_pendaftaran', 'x_nama_lengkap', 'nama_lengkap', '`nama_lengkap`', '`nama_lengkap`', 200, -1, FALSE, '`nama_lengkap`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->nama_lengkap->Sortable = TRUE; // Allow sort
		$this->fields['nama_lengkap'] = &$this->nama_lengkap;

		// nisn
		$this->nisn = new cField('bukti_pendaftaran', 'bukti_pendaftaran', 'x_nisn', 'nisn', '`nisn`', '`nisn`', 200, -1, FALSE, '`nisn`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->nisn->Sortable = TRUE; // Allow sort
		$this->fields['nisn'] = &$this->nisn;

		// tempat_lahir
		$this->tempat_lahir = new cField('bukti_pendaftaran', 'bukti_pendaftaran', 'x_tempat_lahir', 'tempat_lahir', '`tempat_lahir`', '`tempat_lahir`', 200, -1, FALSE, '`tempat_lahir`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->tempat_lahir->Sortable = TRUE; // Allow sort
		$this->fields['tempat_lahir'] = &$this->tempat_lahir;

		// tanggal_lahir
		$this->tanggal_lahir = new cField('bukti_pendaftaran', 'bukti_pendaftaran', 'x_tanggal_lahir', 'tanggal_lahir', '`tanggal_lahir`', '`tanggal_lahir`', 200, 7, FALSE, '`tanggal_lahir`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// jenis_kelamin
		$this->jenis_kelamin = new cField('bukti_pendaftaran', 'bukti_pendaftaran', 'x_jenis_kelamin', 'jenis_kelamin', '`jenis_kelamin`', '`jenis_kelamin`', 200, -1, FALSE, '`jenis_kelamin`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->jenis_kelamin->Sortable = TRUE; // Allow sort
		$this->fields['jenis_kelamin'] = &$this->jenis_kelamin;

		// sekolah_asal
		$this->sekolah_asal = new cField('bukti_pendaftaran', 'bukti_pendaftaran', 'x_sekolah_asal', 'sekolah_asal', '`sekolah_asal`', '`sekolah_asal`', 200, -1, FALSE, '`sekolah_asal`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->sekolah_asal->Sortable = TRUE; // Allow sort
		$this->fields['sekolah_asal'] = &$this->sekolah_asal;

		// alamat
		$this->alamat = new cField('bukti_pendaftaran', 'bukti_pendaftaran', 'x_alamat', 'alamat', '`alamat`', '`alamat`', 201, -1, FALSE, '`alamat`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->alamat->Sortable = TRUE; // Allow sort
		$this->fields['alamat'] = &$this->alamat;

		// zona
		$this->zona = new cField('bukti_pendaftaran', 'bukti_pendaftaran', 'x_zona', 'zona', '`zona`', '`zona`', 200, -1, FALSE, '`zona`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->zona->Sortable = TRUE; // Allow sort
		$this->fields['zona'] = &$this->zona;

		// nilai_akhir
		$this->nilai_akhir = new cField('bukti_pendaftaran', 'bukti_pendaftaran', 'x_nilai_akhir', 'nilai_akhir', '`nilai_akhir`', '`nilai_akhir`', 3, -1, FALSE, '`nilai_akhir`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// nama_ayah
		$this->nama_ayah = new cField('bukti_pendaftaran', 'bukti_pendaftaran', 'x_nama_ayah', 'nama_ayah', '`nama_ayah`', '`nama_ayah`', 200, -1, FALSE, '`nama_ayah`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->nama_ayah->Sortable = TRUE; // Allow sort
		$this->fields['nama_ayah'] = &$this->nama_ayah;

		// nama_ibu
		$this->nama_ibu = new cField('bukti_pendaftaran', 'bukti_pendaftaran', 'x_nama_ibu', 'nama_ibu', '`nama_ibu`', '`nama_ibu`', 200, -1, FALSE, '`nama_ibu`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->nama_ibu->Sortable = TRUE; // Allow sort
		$this->fields['nama_ibu'] = &$this->nama_ibu;

		// nama_wali
		$this->nama_wali = new cField('bukti_pendaftaran', 'bukti_pendaftaran', 'x_nama_wali', 'nama_wali', '`nama_wali`', '`nama_wali`', 200, -1, FALSE, '`nama_wali`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->nama_wali->Sortable = TRUE; // Allow sort
		$this->fields['nama_wali'] = &$this->nama_wali;

		// persyaratan
		$this->persyaratan = new cField('bukti_pendaftaran', 'bukti_pendaftaran', 'x_persyaratan', 'persyaratan', '`persyaratan`', '`persyaratan`', 200, -1, FALSE, '`persyaratan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		$this->persyaratan->Sortable = TRUE; // Allow sort
		$this->persyaratan->OptionCount = 2;
		$this->fields['persyaratan'] = &$this->persyaratan;

		// catatan
		$this->catatan = new cField('bukti_pendaftaran', 'bukti_pendaftaran', 'x_catatan', 'catatan', '`catatan`', '`catatan`', 201, -1, FALSE, '`catatan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`bukti_pendaftaran`";
	}
	...
	function getSqlSelectList() { // Select for List page
		$select = "";
		$select = "SELECT * FROM (" .
			"SELECT *, (SELECT `nopes` FROM `db_pd` `EW_TMP_LOOKUPTABLE` WHERE `EW_TMP_LOOKUPTABLE`.`nopes` = `bukti_pendaftaran`.`nomor_peserta_ujian_sdmi` LIMIT 1) AS `EV__nomor_peserta_ujian_sdmi` FROM `bukti_pendaftaran`" .
			") `EW_TMP_TABLE`";
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "bukti_pendaftaranlist.php";
		}
	}
	...
	function GetModalCaption($pageName) {
		global $Language;
		if ($pageName == "bukti_pendaftaranview.php")
			return $Language->Phrase("View");
		elseif ($pageName == "bukti_pendaftaranedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "bukti_pendaftaranadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("bukti_pendaftaranview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("bukti_pendaftaranview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "bukti_pendaftaranadd.php?" . $this->UrlParm($parm);
		else
			$url = "bukti_pendaftaranadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("bukti_pendaftaranedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("bukti_pendaftaranadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("bukti_pendaftarandelete.php", $this->UrlParm());
	}
	...
	function GetUserIDSubquery(&$fld, &$masterfld) {
		...
		$sWrk = "";
		$sSql = "SELECT " . $masterfld->FldExpression . " FROM `bukti_pendaftaran`";
	...
	function GetAutoFill($id, $val) {
		...
		if (preg_match('/^x(\d)*_nomor_peserta_ujian_sdmi$/', $id)) {
			$conn = &$this->Connection();
			$sSqlWrk = "SELECT `asal_sek` AS FIELD0, `nm_pes` AS FIELD1, `tmp_lhr` AS FIELD2, `sex` AS FIELD3, `nm_ortu` AS FIELD4 FROM `db_pd`";
			...
			if ($rs = ew_LoadRecordset($sSqlWrk, $conn)) {
				while ($rs && !$rs->EOF) {
					...
					$this->tempat_lahir->setDbValue($rs->fields[2]);
					$this->jenis_kelamin->setDbValue($rs->fields[3]);
					$this->nama_ayah->setDbValue($rs->fields[4]);
					...
					$ar[] = ($this->tempat_lahir->AutoFillOriginalValue) ? $this->tempat_lahir->CurrentValue : $this->tempat_lahir->EditValue;
					$ar[] = ($this->jenis_kelamin->AutoFillOriginalValue) ? $this->jenis_kelamin->CurrentValue : $this->jenis_kelamin->EditValue;
