...
//
// Table class for pendaftar
//
class cpendaftar extends cTable {
	var $id_pendaftar;
	var $nama_ruang;
	...
	function __construct() {
		...
		$this->TableVar = 'pendaftar';
		$this->TableName = 'pendaftar';
		...
		// id_pendaftar
		$this->id_pendaftar = new cField('pendaftar', 'pendaftar', 'x_id_pendaftar', 'id_pendaftar', '`id_pendaftar`', '`id_pendaftar`', 3, -1, FALSE, '`id_pendaftar`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// nama_ruang
		$this->nama_ruang = new cField('pendaftar', 'pendaftar', 'x_nama_ruang', 'nama_ruang', '`nama_ruang`', '`nama_ruang`', 200, -1, FALSE, '`nama_ruang`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// nomor_pendaftaran
		$this->nomor_pendaftaran = new cField('pendaftar', 'pendaftar', 'x_nomor_pendaftaran', 'nomor_pendaftaran', '`nomor_pendaftaran`', '`nomor_pendaftaran`', 200, -1, FALSE, '`nomor_pendaftaran`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->nomor_peserta_ujian_sdmi = new cField('pendaftar', 'pendaftar', 'x_nomor_peserta_ujian_sdmi', 'nomor_peserta_ujian_sdmi', '`nomor_peserta_ujian_sdmi`', '`nomor_peserta_ujian_sdmi`', 200, -1, FALSE, '`nomor_peserta_ujian_sdmi`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// sekolah_asal
		$this->sekolah_asal = new cField('pendaftar', 'pendaftar', 'x_sekolah_asal', 'sekolah_asal', '`sekolah_asal`', '`sekolah_asal`', 200, -1, FALSE, '`sekolah_asal`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->sekolah_asal->Sortable = TRUE; // Allow sort
		$this->fields['sekolah_asal'] = &$this->sekolah_asal;

		// nama_lengkap
		$this->nama_lengkap = new cField('pendaftar', 'pendaftar', 'x_nama_lengkap', 'nama_lengkap', '`nama_lengkap`', '`nama_lengkap`', 200, -1, FALSE, '`nama_lengkap`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->nama_lengkap->Sortable = TRUE; // Allow sort
		$this->fields['nama_lengkap'] = &$this->nama_lengkap;

		// nik
		$this->nik = new cField('pendaftar', 'pendaftar', 'x_nik', 'nik', '`nik`', '`nik`', 200, -1, FALSE, '`nik`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->nik->Sortable = TRUE; // Allow sort
		$this->fields['nik'] = &$this->nik;

		// nisn
		$this->nisn = new cField('pendaftar', 'pendaftar', 'x_nisn', 'nisn', '`nisn`', '`nisn`', 200, -1, FALSE, '`nisn`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->nisn->Sortable = TRUE; // Allow sort
		$this->fields['nisn'] = &$this->nisn;

		// tempat_lahir
		$this->tempat_lahir = new cField('pendaftar', 'pendaftar', 'x_tempat_lahir', 'tempat_lahir', '`tempat_lahir`', '`tempat_lahir`', 200, -1, FALSE, '`tempat_lahir`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->tempat_lahir->Sortable = TRUE; // Allow sort
		$this->fields['tempat_lahir'] = &$this->tempat_lahir;

		// tanggal_lahir
		$this->tanggal_lahir = new cField('pendaftar', 'pendaftar', 'x_tanggal_lahir', 'tanggal_lahir', '`tanggal_lahir`', '`tanggal_lahir`', 200, 7, FALSE, '`tanggal_lahir`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// jenis_kelamin
		$this->jenis_kelamin = new cField('pendaftar', 'pendaftar', 'x_jenis_kelamin', 'jenis_kelamin', '`jenis_kelamin`', '`jenis_kelamin`', 200, -1, FALSE, '`jenis_kelamin`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		$this->jenis_kelamin->Sortable = TRUE; // Allow sort
		$this->jenis_kelamin->OptionCount = 2;
		$this->fields['jenis_kelamin'] = &$this->jenis_kelamin;

		// agama
		$this->agama = new cField('pendaftar', 'pendaftar', 'x_agama', 'agama', '`agama`', '`agama`', 200, -1, FALSE, '`agama`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// alamat
		$this->alamat = new cField('pendaftar', 'pendaftar', 'x_alamat', 'alamat', '`alamat`', '`alamat`', 201, -1, FALSE, '`alamat`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->alamat->Sortable = TRUE; // Allow sort
		$this->fields['alamat'] = &$this->alamat;

		// kecamatan
		$this->kecamatan = new cField('pendaftar', 'pendaftar', 'x_kecamatan', 'kecamatan', '`kecamatan`', '`kecamatan`', 200, -1, FALSE, '`kecamatan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// zona
		$this->zona = new cField('pendaftar', 'pendaftar', 'x_zona', 'zona', '`zona`', '`zona`', 200, -1, FALSE, '`zona`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->zona->Sortable = TRUE; // Allow sort
		$this->fields['zona'] = &$this->zona;

		// n_ind
		$this->n_ind = new cField('pendaftar', 'pendaftar', 'x_n_ind', 'n_ind', '`n_ind`', '`n_ind`', 200, -1, FALSE, '`n_ind`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->n_ind->Sortable = TRUE; // Allow sort
		$this->fields['n_ind'] = &$this->n_ind;

		// n_mat
		$this->n_mat = new cField('pendaftar', 'pendaftar', 'x_n_mat', 'n_mat', '`n_mat`', '`n_mat`', 200, -1, FALSE, '`n_mat`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->n_mat->Sortable = TRUE; // Allow sort
		$this->fields['n_mat'] = &$this->n_mat;

		// n_ipa
		$this->n_ipa = new cField('pendaftar', 'pendaftar', 'x_n_ipa', 'n_ipa', '`n_ipa`', '`n_ipa`', 200, -1, FALSE, '`n_ipa`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->n_ipa->Sortable = TRUE; // Allow sort
		$this->fields['n_ipa'] = &$this->n_ipa;

		// jumlah_nilai_usum
		$this->jumlah_nilai_usum = new cField('pendaftar', 'pendaftar', 'x_jumlah_nilai_usum', 'jumlah_nilai_usum', '`jumlah_nilai_usum`', '`jumlah_nilai_usum`', 200, -1, FALSE, '`jumlah_nilai_usum`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->jumlah_nilai_usum->Sortable = TRUE; // Allow sort
		$this->fields['jumlah_nilai_usum'] = &$this->jumlah_nilai_usum;

		// bonus_prestasi
		$this->bonus_prestasi = new cField('pendaftar', 'pendaftar', 'x_bonus_prestasi', 'bonus_prestasi', '`bonus_prestasi`', '`bonus_prestasi`', 200, -1, FALSE, '`bonus_prestasi`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// nama_prestasi
		$this->nama_prestasi = new cField('pendaftar', 'pendaftar', 'x_nama_prestasi', 'nama_prestasi', '`nama_prestasi`', '`nama_prestasi`', 200, -1, FALSE, '`nama_prestasi`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->nama_prestasi->Sortable = TRUE; // Allow sort
		$this->fields['nama_prestasi'] = &$this->nama_prestasi;

		// jumlah_bonus_prestasi
		$this->jumlah_bonus_prestasi = new cField('pendaftar', 'pendaftar', 'x_jumlah_bonus_prestasi', 'jumlah_bonus_prestasi', '`jumlah_bonus_prestasi`', '`jumlah_bonus_prestasi`', 200, -1, FALSE, '`jumlah_bonus_prestasi`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'HIDDEN');
		...
		$this->kepemilikan_ijasah_mda = new cField('pendaftar', 'pendaftar', 'x_kepemilikan_ijasah_mda', 'kepemilikan_ijasah_mda', '`kepemilikan_ijasah_mda`', '`kepemilikan_ijasah_mda`', 200, -1, FALSE, '`kepemilikan_ijasah_mda`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		$this->kepemilikan_ijasah_mda->Sortable = TRUE; // Allow sort
		$this->fields['kepemilikan_ijasah_mda'] = &$this->kepemilikan_ijasah_mda;

		// nilai_mda
		$this->nilai_mda = new cField('pendaftar', 'pendaftar', 'x_nilai_mda', 'nilai_mda', '`nilai_mda`', '`nilai_mda`', 200, -1, FALSE, '`nilai_mda`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'HIDDEN');
		...
		// nilai_akhir
		$this->nilai_akhir = new cField('pendaftar', 'pendaftar', 'x_nilai_akhir', 'nilai_akhir', '`nilai_akhir`', '`nilai_akhir`', 200, -1, FALSE, '`nilai_akhir`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->nilai_akhir->Sortable = TRUE; // Allow sort
		$this->fields['nilai_akhir'] = &$this->nilai_akhir;

		// nama_ayah
		$this->nama_ayah = new cField('pendaftar', 'pendaftar', 'x_nama_ayah', 'nama_ayah', '`nama_ayah`', '`nama_ayah`', 200, -1, FALSE, '`nama_ayah`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->nama_ayah->Sortable = TRUE; // Allow sort
		$this->fields['nama_ayah'] = &$this->nama_ayah;

		// nama_ibu
		$this->nama_ibu = new cField('pendaftar', 'pendaftar', 'x_nama_ibu', 'nama_ibu', '`nama_ibu`', '`nama_ibu`', 200, -1, FALSE, '`nama_ibu`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->nama_ibu->Sortable = TRUE; // Allow sort
		$this->fields['nama_ibu'] = &$this->nama_ibu;

		// nama_wali
		$this->nama_wali = new cField('pendaftar', 'pendaftar', 'x_nama_wali', 'nama_wali', '`nama_wali`', '`nama_wali`', 200, -1, FALSE, '`nama_wali`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->nama_wali->Sortable = TRUE; // Allow sort
		$this->fields['nama_wali'] = &$this->nama_wali;

		// status
		$this->status = new cField('pendaftar', 'pendaftar', 'x_status', 'status', '`status`', '`status`', 200, -1, FALSE, '`status`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->status->Sortable = TRUE; // Allow sort
		$this->fields['status'] = &$this->status;

		// persyaratan
		$this->persyaratan = new cField('pendaftar', 'pendaftar', 'x_persyaratan', 'persyaratan', '`persyaratan`', '`persyaratan`', 200, -1, FALSE, '`persyaratan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		$this->persyaratan->Sortable = TRUE; // Allow sort
		$this->persyaratan->OptionCount = 2;
		$this->fields['persyaratan'] = &$this->persyaratan;

		// catatan
		$this->catatan = new cField('pendaftar', 'pendaftar', 'x_catatan', 'catatan', '`catatan`', '`catatan`', 201, -1, FALSE, '`catatan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->catatan->Sortable = TRUE; // Allow sort
		$this->fields['catatan'] = &$this->catatan;

		// keterangan
		$this->keterangan = new cField('pendaftar', 'pendaftar', 'x_keterangan', 'keterangan', '`keterangan`', '`keterangan`', 200, -1, FALSE, '`keterangan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "pendaftaredit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "pendaftaradd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("pendaftarview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("pendaftarview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "pendaftaradd.php?" . $this->UrlParm($parm);
		else
			$url = "pendaftaradd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("pendaftaredit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("pendaftaradd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("pendaftardelete.php", $this->UrlParm());
	}
	...
	function GetAutoFill($id, $val) {
		...
		if (preg_match('/^x(\d)*_nomor_peserta_ujian_sdmi$/', $id)) {
			$conn = &$this->Connection();
			$sSqlWrk = "SELECT `asal_sek` AS FIELD0, `nm_pes` AS FIELD1, `nisn` AS FIELD2, `n_ind` AS FIELD3, `n_mat` AS FIELD4, `n_ipa` AS FIELD5, `n_jml` AS FIELD6, `nm_ortu` AS FIELD7 FROM `db_pd`";
			...
			if ($rs = ew_LoadRecordset($sSqlWrk, $conn)) {
				while ($rs && !$rs->EOF) {
					...
					$this->nisn->setDbValue($rs->fields[2]);
					$this->n_ind->setDbValue($rs->fields[3]);
					$this->n_mat->setDbValue($rs->fields[4]);
					$this->n_ipa->setDbValue($rs->fields[5]);
					$this->jumlah_nilai_usum->setDbValue($rs->fields[6]);
					$this->nama_ayah->setDbValue($rs->fields[7]);
					...
					$ar[] = ($this->nisn->AutoFillOriginalValue) ? $this->nisn->CurrentValue : $this->nisn->EditValue;
					$ar[] = ($this->n_ind->AutoFillOriginalValue) ? $this->n_ind->CurrentValue : $this->n_ind->EditValue;
					$ar[] = ($this->n_mat->AutoFillOriginalValue) ? $this->n_mat->CurrentValue : $this->n_mat->EditValue;
					$ar[] = ($this->n_ipa->AutoFillOriginalValue) ? $this->n_ipa->CurrentValue : $this->n_ipa->EditValue;
					$ar[] = ($this->jumlah_nilai_usum->AutoFillOriginalValue) ? $this->jumlah_nilai_usum->CurrentValue : $this->jumlah_nilai_usum->EditValue;
					$ar[] = ($this->nama_ayah->AutoFillOriginalValue) ? $this->nama_ayah->CurrentValue : $this->nama_ayah->EditValue;
					$rowcnt += 1;
					$rsarr[] = $ar;
					$rs->MoveNext();
				}
